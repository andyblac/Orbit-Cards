...
function it(e) {
	...
	let t = e.toString().trim();
	return t === "theme" ? "rgba(var(--color-theme), 0.3)" : F(t, 70);
}
function at(e) {
	if (!e) return "rgba(var(--color-theme), 0.2)";
	let t = e.toString().trim();
	return t === "theme" ? "rgba(var(--color-theme), 0.05)" : F(t, 20);
}
function ot(e) {
	return e ? F(e.toString().trim(), 25) : "rgba(var(--color-theme), 0.25)";
}
function st(e) {
	let t = gt(e);
...
function F(e, t) {
	...
	return `color-mix(in srgb, transparent, ${ht(n) ? n : st(n)} ${t}%)`;
}
function ht(e) {
	let t = e.toString().trim();
...
function _t(e, t, n = "Card") {
	if (e.name) return e.name;
	if (e.card_name) return e.card_name;
	if (e.area_name) return vt(e.area_name, e, t, n);
	if (e.room_name) return vt(e.room_name, e, t, n);
	let r = e.area;
...
function yt(e, t, n, r) {
	...
	if (e.type === "area") return bt(t, n) || "";
	if (e.type === "floor") return xt(t, n) || "";
	let i = St(t, n);
...
var Ct = "https://github.com/andyblac/Orbit-Cards/wiki", wt = {
	"orbit-area-card-dev": {
		default: "Area-Card",
...
function Et(e, t = "default") {
	let n = wt[Tt(e)], r = n?.[t] || n?.default;
	return r ? `${Ct}/${r}` : `${Ct}`;
}
function Dt(e, t, n = "default") {
	let r = Et(t, n);
	queueMicrotask(() => {
		let t = Ot(e, "hui-dialog-edit-card") || Ot(e, "hui-dialog-edit-badge");
...
function kt({ tag: e, cardClass: t, name: n, description: r, version: a, getEntitySuggestion: o, documentationURL: s, aliases: c = [] }) {
	...
	window.customCards.push({
		...
		preview: !0,
		version: a,
		documentationURL: s || Et(e),
		getEntitySuggestion: o
	}), i(n, a);
}
//#endregion
//#region src/common/helpers/templates.js
var At = "__ORBIT_TEMPLATE_RESULT_START_8C4F2A__", jt = "__ORBIT_TEMPLATE_RESULT_END_8C4F2A__";
function Mt(e) {
	if (typeof e != "string") return e;
	let t = e.trim();
	return !t || Nt(t) ? e : `{{ ${t} }}`;
...
function zt(e) {
	let t = String(e ?? ""), n = t.indexOf(At), r = t.lastIndexOf(jt);
...
function Gt(e = {}) {
	let t = { ...e || {} }, n = !1;
	return t.type === "custom:orbit-room-card-dev" && (t.type = "custom:orbit-area-card-dev", n = !0), Object.prototype.hasOwnProperty.call(t, "room_name") && (t.area_name === void 0 && t.room_name !== void 0 && t.room_name !== "" && (t.area_name = t.room_name), delete t.room_name, n = !0), n = $t(t) || n, {
		config: n ? t : e,
		migrated: n
	};
}
...
function qt(e) {
	return Jt(e, "orbit-status-card-dev") ? Yt(e) : Jt(e, "orbit-deck-card-dev") ? Kt(e) : {
		config: e,
		migrated: !1
	};
}
...
function Yt(e = {}) {
	let t = { ...e || {} }, n = $t(t);
	if (n = Qt(t) || n, n = Zt(t) || n, n = Xt(t) || n, Object.prototype.hasOwnProperty.call(t, "main_entity") && (t.entity === void 0 && t.main_entity !== void 0 && t.main_entity !== "" && (t.entity = t.main_entity), delete t.main_entity, n = !0), Array.isArray(t.entities)) {
		let e = t.entities.map((e) => {
			if (!e || typeof e == "string") return e;
			let t = { ...e }, r = $t(t), i = Qt(t), a = Zt(t), o = Xt(t), s = r || i || a || o;
			return n ||= s, s ? t : e;
		});
		n && (t.entities = e);
	}
...
var rn = "<svg xmlns=\"http://www.w3.org/2000/svg\"\n     width=\"120\"\n     height=\"120\"\n     viewBox=\"0 0 24 24\"\n     fill=\"none\">\n\n  <style>\n    .spinner {\n      transform-origin: center;\n      animation: spin 1.2s linear infinite;\n    }\n\n    @keyframes spin {\n      100% {\n        transform: rotate(360deg);\n      }\n    }\n  </style>\n\n  <g class=\"spinner\">\n    <path\n      fill=\"black\"\n      d=\"M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12.5,2C17,2 17.11,5.57 14.75,6.75C13.76,7.24 13.32,8.29 13.13,9.22C13.61,9.42 14.03,9.73 14.35,10.13C18.05,8.13 22.03,8.92 22.03,12.5C22.03,17 18.46,17.1 17.28,14.73C16.78,13.74 15.72,13.3 14.79,13.11C14.59,13.59 14.28,14 13.88,14.34C15.87,18.03 15.08,22 11.5,22C7,22 6.91,18.42 9.27,17.24C10.25,16.75 10.69,15.71 10.89,14.79C10.4,14.59 9.97,14.27 9.65,13.87C5.96,15.85 2,15.07 2,11.5C2,7 5.56,6.89 6.74,9.26C7.24,10.25 8.29,10.68 9.22,10.87C9.41,10.39 9.73,9.97 10.14,9.65C8.15,5.96 8.94,2 12.5,2Z\"\n    />\n  </g>\n\n</svg>", an = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\">\n  <title>garage-fixed</title>\n\n  <!-- Frame -->\n  <path d=\"M22 9V20H20V11H4V20H2V9L12 5L22 9\" fill=\"currentColor\"/>\n\n  <clipPath id=\"doorClip\">\n    <rect x=\"4\" y=\"11\" width=\"16\" height=\"9\" />\n  </clipPath>\n\n  <g clip-path=\"url(#doorClip)\">\n\n    <!-- Animated group (NO base transform!) -->\n    <g>\n\n      <!-- Door panels -->\n      <path d=\"M19 12H5V14H19V12Z\" fill=\"currentColor\"/>\n      <path d=\"M19 15H5V17H19V15Z\" fill=\"currentColor\"/>\n      <path d=\"M19 18H5V20H19V18Z\" fill=\"currentColor\"/>\n\n      <!-- Start OPEN via animation itself -->\n      <animateTransform\n        attributeName=\"transform\"\n        type=\"translate\"\n        from=\"0 -10\"\n        to=\"0 0\"\n        dur=\"1.5s\"\n        begin=\"0s\"\n        fill=\"freeze\"\n      />\n\n    </g>\n  </g>\n</svg>", on = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\">\n  <title>garage-variant-open</title>\n\n  <!-- Frame / roof -->\n  <path d=\"M22 9V20H20V11H4V20H2V9L12 5L22 9\" fill=\"currentColor\"/>\n\n  <!-- Clip area -->\n  <clipPath id=\"doorClip\">\n    <rect x=\"4\" y=\"11\" width=\"16\" height=\"9\" />\n  </clipPath>\n\n  <g clip-path=\"url(#doorClip)\">\n\n    <!-- Door group (FINAL STATE is open) -->\n    <g class=\"door\" transform=\"translate(0 -10)\">\n\n      <!-- Door panels -->\n      <path d=\"M19 12H5V14H19V12Z\" fill=\"currentColor\"/>\n      <path d=\"M19 15H5V17H19V15Z\" fill=\"currentColor\"/>\n      <path d=\"M19 18H5V20H19V18Z\" fill=\"currentColor\"/>\n\n      <!-- Optional SMIL animation (safe fallback style) -->\n      <animateTransform\n        attributeName=\"transform\"\n        type=\"translate\"\n        from=\"0 0\"\n        to=\"0 -10\"\n        dur=\"1.5s\"\n        begin=\"0s\"\n        fill=\"freeze\"\n      />\n    </g>\n\n  </g>\n</svg>", sn = "<svg xmlns=\"http://www.w3.org/2000/svg\"\n     viewBox=\"0 0 24 24\">\n\n  <style>\n    .arc {\n      opacity: 0;\n      animation-duration: 2s;\n      animation-iteration-count: infinite;\n    }\n\n    /* arc 1 appears first and stays on */\n    .a1 {\n      animation-name: arc1;\n    }\n\n    /* arc 2 appears second and stays on */\n    .a2 {\n      animation-name: arc2;\n    }\n\n    /* arc 3 appears third and stays on */\n    .a3 {\n      animation-name: arc3;\n    }\n\n    @keyframes arc1 {\n      0%   { opacity: 0; }\n      10%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n\n    @keyframes arc2 {\n      0%   { opacity: 0; }\n      25%  { opacity: 0; }\n      35%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n\n    @keyframes arc3 {\n      0%   { opacity: 0; }\n      50%  { opacity: 0; }\n      60%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n  </style>\n\n  <!-- RADAR ARCS -->\n  <path class=\"arc a1\" fill=\"currentColor\"\n    d=\"M21,1A2,2 0 0,0 23,3V1H21\"/>\n\n  <path class=\"arc a2\" fill=\"currentColor\"\n    d=\"M18.33,1C18.33,3.58 20.42,5.67 23,5.67V4.33C21.16,4.33 19.67,2.84 19.67,1H18.33\"/>\n\n  <path class=\"arc a3\" fill=\"currentColor\"\n    d=\"M15.67,1A7.33,7.33 0 0,0 23,8.33V7A6,6 0 0,1 17,1H15.67\"/>\n\n  <!-- MAIN ICON -->\n  <path fill=\"currentColor\"\n    d=\"M10,0.2C9,0.2 8.2,1 8.2,2C8.2,3 9,3.8 10,3.8C11,3.8 11.8,3 11.8,2C11.8,1 11,0.2 10,0.2M7.92,4.03C7.75,4.03 7.58,4.06 7.42,4.11L2,5.8V11H3.8V7.33L5.91,6.67L2,22H3.8L6.67,13.89L9,17V22H10.8V15.59L8.31,11.05L9.04,8.18L10.12,10H15V8.2H11.38L9.38,4.87C9.08,4.37 8.54,4.03 7.92,4.03Z\"\n  />\n</svg>", cn = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" style=\"color: inherit;\">\n  <g class=\"start\">\n    <path\n      fill=\"currentColor\"\n      d=\"M10,0.2C9,0.2 8.2,1 8.2,2C8.2,3 9,3.8 10,3.8C11,3.8 11.8,3 11.8,2C11.8,1 11,0.2 10,0.2M7.92,4.03C7.75,4.03 7.58,4.06 7.42,4.11L2,5.8V11H3.8V7.33L5.91,6.67L2,22H3.8L6.67,13.89L9,17V22H10.8V15.59L8.31,11.05L9.04,8.18L10.12,10H15V8.2H11.38L9.38,4.87C9.08,4.37 8.54,4.03 7.92,4.03Z\"/>\n  </g>\n</svg>", ln = "<svg xmlns=\"http://www.w3.org/2000/svg\"\n     viewBox=\"0 0 24 24\">\n\n  <style>\n    .arc {\n      opacity: 0;\n      animation-duration: 2s;\n      animation-iteration-count: infinite;\n    }\n\n    /* arc 1 appears first and stays on */\n    .a1 {\n      animation-name: arc1;\n    }\n\n    /* arc 2 appears second and stays on */\n    .a2 {\n      animation-name: arc2;\n    }\n\n    /* arc 3 appears third and stays on */\n    .a3 {\n      animation-name: arc3;\n    }\n\n    @keyframes arc1 {\n      0%   { opacity: 0; }\n      10%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n\n    @keyframes arc2 {\n      0%   { opacity: 0; }\n      25%  { opacity: 0; }\n      35%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n\n    @keyframes arc3 {\n      0%   { opacity: 0; }\n      50%  { opacity: 0; }\n      60%  { opacity: 1; }\n      75%  { opacity: 1; }\n      100% { opacity: 0; }\n    }\n  </style>\n\n  <!-- RADAR ARCS -->\n  <path class=\"arc a1\" fill=\"currentColor\"\n    d=\"M21,1A2,2 0 0,0 23,3V1H21\"/>\n\n  <path class=\"arc a2\" fill=\"currentColor\"\n    d=\"M18.33,1C18.33,3.58 20.42,5.67 23,5.67V4.33C21.16,4.33 19.67,2.84 19.67,1H18.33\"/>\n\n  <path class=\"arc a3\" fill=\"currentColor\"\n    d=\"M15.67,1A7.33,7.33 0 0,0 23,8.33V7A6,6 0 0,1 17,1H15.67\"/>\n\n  <!-- MAIN ICON -->\n  <path fill=\"currentColor\"\n    d=\"M10,0.2C9,0.2 8.2,1 8.2,2C8.2,3 9,3.8 10,3.8C11,3.8 11.8,3 11.8,2C11.8,1 11,0.2 10,0.2M7.92,4.03C7.75,4.03 7.58,4.06 7.42,4.11L2,5.8V11H3.8V7.33L5.91,6.67L2,22H3.8L6.67,13.89L9,17V22H10.8V15.59L8.31,11.05L9.04,8.18L10.12,10H15V8.2H11.38L9.38,4.87C9.08,4.37 8.54,4.03 7.92,4.03Z\"\n  />\n</svg>", un = "<?xml version=\"1.0\" encoding=\"utf-8\"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->\r\n<svg fill=\"#000000\" width=\"800px\" height=\"800px\" viewBox=\"0 0 50 50\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><path d=\"M22 0L22 7.28125C22.972656 7.109375 23.972656 7 25 7C26.027344 7 27.027344 7.109375 28 7.28125L28 0 Z M 25 9C18.394531 9 12.871094 13.273438 11.40625 19L38.59375 19C37.128906 13.273438 31.605469 9 25 9 Z M 10 21C8.347656 21 7 22.347656 7 24C7 25.652344 8.347656 27 10 27L40 27C41.652344 27 43 25.652344 43 24C43 22.347656 41.652344 21 40 21 Z M 17 30C15.894531 30 15 30.894531 15 32C15 33.105469 15.894531 34 17 34C18.105469 34 19 33.105469 19 32C19 30.894531 18.105469 30 17 30 Z M 25 30C23.894531 30 23 30.894531 23 32C23 33.105469 23.894531 34 25 34C26.105469 34 27 33.105469 27 32C27 30.894531 26.105469 30 25 30 Z M 33 30C31.894531 30 31 30.894531 31 32C31 33.105469 31.894531 34 33 34C34.105469 34 35 33.105469 35 32C35 30.894531 34.105469 30 33 30 Z M 13 38C11.894531 38 11 38.894531 11 40C11 41.105469 11.894531 42 13 42C14.105469 42 15 41.105469 15 40C15 38.894531 14.105469 38 13 38 Z M 21 38C19.894531 38 19 38.894531 19 40C19 41.105469 19.894531 42 21 42C22.105469 42 23 41.105469 23 40C23 38.894531 22.105469 38 21 38 Z M 29 38C27.894531 38 27 38.894531 27 40C27 41.105469 27.894531 42 29 42C30.105469 42 31 41.105469 31 40C31 38.894531 30.105469 38 29 38 Z M 37 38C35.894531 38 35 38.894531 35 40C35 41.105469 35.894531 42 37 42C38.105469 42 39 41.105469 39 40C39 38.894531 38.105469 38 37 38 Z M 9 46C7.894531 46 7 46.894531 7 48C7 49.105469 7.894531 50 9 50C10.105469 50 11 49.105469 11 48C11 46.894531 10.105469 46 9 46 Z M 17 46C15.894531 46 15 46.894531 15 48C15 49.105469 15.894531 50 17 50C18.105469 50 19 49.105469 19 48C19 46.894531 18.105469 46 17 46 Z M 25 46C23.894531 46 23 46.894531 23 48C23 49.105469 23.894531 50 25 50C26.105469 50 27 49.105469 27 48C27 46.894531 26.105469 46 25 46 Z M 33 46C31.894531 46 31 46.894531 31 48C31 49.105469 31.894531 50 33 50C34.105469 50 35 49.105469 35 48C35 46.894531 34.105469 46 33 46 Z M 41 46C39.894531 46 39 46.894531 39 48C39 49.105469 39.894531 50 41 50C42.105469 50 43 49.105469 43 48C43 46.894531 42.105469 46 41 46Z\"/></svg>", dn = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<svg width=\"800px\" height=\"800px\" viewBox=\"0 0 50 50\" xmlns=\"http://www.w3.org/2000/svg\" role=\"img\" aria-labelledby=\"title desc\">\n  <title id=\"title\">Animated shower</title>\n  <desc id=\"desc\">A shower head icon with animated falling water droplets.</desc>\n  <style>\n    .fixture {\n      fill: #111111;\n    }\n\n    .drop {\n      fill: #1597d3;\n      opacity: 0;\n      transform-box: fill-box;\n      transform-origin: center;\n      animation: fall 1.35s linear infinite;\n    }\n\n    .drop:nth-child(1) { animation-delay: 0s; }\n    .drop:nth-child(2) { animation-delay: .18s; }\n    .drop:nth-child(3) { animation-delay: .36s; }\n    .drop:nth-child(4) { animation-delay: .54s; }\n    .drop:nth-child(5) { animation-delay: .72s; }\n    .drop:nth-child(6) { animation-delay: .9s; }\n    .drop:nth-child(7) { animation-delay: 1.08s; }\n    .drop:nth-child(8) { animation-delay: .12s; }\n    .drop:nth-child(9) { animation-delay: .3s; }\n    .drop:nth-child(10) { animation-delay: .48s; }\n    .drop:nth-child(11) { animation-delay: .66s; }\n    .drop:nth-child(12) { animation-delay: .84s; }\n\n    @keyframes fall {\n      0% {\n        opacity: 0;\n        transform: translateY(-8px) scale(.72);\n      }\n      18% {\n        opacity: 1;\n      }\n      72% {\n        opacity: .95;\n      }\n      100% {\n        opacity: 0;\n        transform: translateY(8px) scale(1);\n      }\n    }\n\n    @media (prefers-reduced-motion: reduce) {\n      .drop {\n        opacity: 1;\n        animation: none;\n      }\n    }\n  </style>\n\n  <path class=\"fixture\" d=\"M22 0L22 7.28125C22.972656 7.109375 23.972656 7 25 7C26.027344 7 27.027344 7.109375 28 7.28125L28 0 Z M25 9C18.394531 9 12.871094 13.273438 11.40625 19L38.59375 19C37.128906 13.273438 31.605469 9 25 9 Z M10 21C8.347656 21 7 22.347656 7 24C7 25.652344 8.347656 27 10 27L40 27C41.652344 27 43 25.652344 43 24C43 22.347656 41.652344 21 40 21 Z\"/>\n\n  <g id=\"water\">\n    <circle class=\"drop\" cx=\"17\" cy=\"32\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"25\" cy=\"32\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"33\" cy=\"32\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"13\" cy=\"40\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"21\" cy=\"40\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"29\" cy=\"40\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"37\" cy=\"40\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"9\" cy=\"48\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"17\" cy=\"48\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"25\" cy=\"48\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"33\" cy=\"48\" r=\"2\"/>\n    <circle class=\"drop\" cx=\"41\" cy=\"48\" r=\"2\"/>\n  </g>\n</svg>\n", fn = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" style=\"color: inherit;\" role=\"img\" aria-labelledby=\"title desc\">\n  <title id=\"title\">Closing shutter</title>\n  <desc id=\"desc\">A blue shutter smoothly closes from twenty percent closed to fully closed.</desc>\n  <style>\n    .shade-closing {\n      transform-box: view-box;\n      transform-origin: 0 4.021px;\n      transform: scaleY(3.943322);\n    }\n\n    .rail-closing {\n      transform: translateY(12.827px);\n    }\n\n    svg[data-orbit-animate=\"true\"] .shade-closing {\n      animation: shade-closing 5s cubic-bezier(0.4, 0, 0.2, 1) forwards;\n    }\n\n    svg[data-orbit-animate=\"true\"] .rail-closing {\n      animation: rail-closing 5s cubic-bezier(0.4, 0, 0.2, 1) forwards;\n    }\n\n    @keyframes shade-closing {\n      from { transform: scaleY(1); }\n      to   { transform: scaleY(3.943322); }\n    }\n\n    @keyframes rail-closing {\n      from { transform: translateY(0); }\n      to   { transform: translateY(12.827px); }\n    }\n  </style>\n\n  <g fill=\"currentColor\" shape-rendering=\"geometricPrecision\">\n    <!-- Top housing -->\n    <path fill-rule=\"evenodd\"\n      d=\"M2.42 2H21.58V3.707H2.42Z M2.991 2.273H6.173V3.359H2.991Z M3.194 2.476H5.97V3.157H3.194Z\"/>\n\n    <!-- Fabric/shade -->\n    <rect class=\"shade-closing\" x=\"2.651\" y=\"4.021\" width=\"18.698\" height=\"4.358\"/>\n\n    <!-- Bottom rail -->\n    <rect class=\"rail-closing\" x=\"2.42\" y=\"8.694\" width=\"19.16\" height=\"0.479\"/>\n  </g>\n</svg>\n", pn = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" style=\"color: inherit;\" role=\"img\" aria-labelledby=\"title desc\">\n  <title id=\"title\">Opening shutter</title>\n  <desc id=\"desc\">A blue shutter smoothly opens from fully closed to twenty percent closed.</desc>\n  <style>\n    .shade-opening {\n      transform-box: view-box;\n      transform-origin: 0 4.021px;\n      transform: scaleY(0.253593);\n    }\n\n    .rail-opening {\n      transform: translateY(-12.827px);\n    }\n\n    svg[data-orbit-animate=\"true\"] .shade-opening {\n      animation: shade-opening 5s cubic-bezier(0.4, 0, 0.2, 1) forwards;\n    }\n\n    svg[data-orbit-animate=\"true\"] .rail-opening {\n      animation: rail-opening 5s cubic-bezier(0.4, 0, 0.2, 1) forwards;\n    }\n\n    @keyframes shade-opening {\n      from { transform: scaleY(1); }\n      to   { transform: scaleY(0.253593); }\n    }\n\n    @keyframes rail-opening {\n      from { transform: translateY(0); }\n      to   { transform: translateY(-12.827px); }\n    }\n  </style>\n\n  <g fill=\"currentColor\" shape-rendering=\"geometricPrecision\">\n    <!-- Top housing -->\n    <path fill-rule=\"evenodd\"\n      d=\"M2.42 2H21.58V3.707H2.42Z M2.991 2.273H6.173V3.359H2.991Z M3.194 2.476H5.97V3.157H3.194Z\"/>\n\n    <!-- Fabric/shade -->\n    <rect class=\"shade-opening\" x=\"2.651\" y=\"4.021\" width=\"18.698\" height=\"17.185\"/>\n\n    <!-- Bottom rail -->\n    <rect class=\"rail-opening\" x=\"2.42\" y=\"21.521\" width=\"19.16\" height=\"0.479\"/>\n  </g>\n</svg>\n", mn = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"120\" height=\"120\" fill=\"currentColor\">\n\n  <style>\n    .swirl {\n      transform-origin: 12px 14px;\n      animation: wash 1.5s ease-in-out infinite;\n    }\n\n    @keyframes wash {\n      0%,100% { transform: rotate(0deg); }\n      25%     { transform: rotate(-20deg); }\n      75%     { transform: rotate(20deg); }\n    }\n  </style>\n\n  <!-- machine -->\n  <path\n    fill=\"currentColor\"\n    d=\"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2\n       M7,4A1,1 0 0,0 6,5A1,1 0 0,0 7,6A1,1 0 0,0 8,5A1,1 0 0,0 7,4\n       M10,4A1,1 0 0,0 9,5A1,1 0 0,0 10,6A1,1 0 0,0 11,5A1,1 0 0,0 10,4\n       M12,8A6,6 0 0,0 6,14A6,6 0 0,0 12,20A6,6 0 0,0 18,14A6,6 0 0,0 12,8Z\" />\n\n  <!-- animated inner swirl -->\n  <path\n    class=\"swirl\"\n    fill=\"currentColor\"\n    d=\"M14.83,11.17\n       C16.39,12.73 16.39,15.27 14.83,16.83\n       C13.27,18.39 10.73,18.39 9.17,16.83\n       L14.83,11.17\" />\n</svg>", hn = [
	...
	"shower_off.svg": un,
	"shower_on.svg": dn,
	"shutter-closing.svg": fn,
	"shutter-opening.svg": pn,
	"washing-machine-running.svg": mn
});
function _n(e) {
	return e?.startsWith("orbit:") && gn[decodeURIComponent(e.slice(6).split("?")[0])] || "";
}
//#endregion
...
function L(e, t = {}) {
	...
	if (o === "loading") return Tn(i, this), "";
	let s = _n(e);
	if (s) {
		let e = Cn(s, n, r);
		return a[i] = e, e;
	}
	return a[i] = "loading", Tn(i, this), Dn(e).then((e) => {
		if (!e.ok) throw Error(`HTTP ${e.status}`);
		return e.text();
	}).then((e) => {
		e = Cn(e, n, r), a[i] = e, En(i);
	}).catch((t) => {
		console.error("SVG load failed:", e, t), delete a[i], En(i);
	}), "";
}
function Sn(e, t) {
...
function zn(e, t = "more-info") {
	...
	} : Rn.has(n) ? { action: "toggle" } : { action: t };
}
//#endregion
...
function Bn(e) {
	...
	this._icon = d || u, this._iconSvgForceColor = f ? this._getSvgColorOverride(f) : !0, this._statusItems = Vn.call(this), this._buttonModels = Gn.call(this), this._curveButtonModels = Kn.call(this), this._actionButtonModel = qn.call(this);
}
function Vn() {
	return [
		1,
		...
		if (!t) return null;
		let n = this.hass?.states[t], r = `status${e}`, i = this._config[`${r}_icon`] || "", a = Un.call(this, r, t), o = a === "custom" ? i : "";
		return {
			entityId: t,
			stateObj: n,
			useStateIcon: a === "entity" && !!n,
			text: Wn.call(this, n, this._config[`status${e}_decimal_places`]),
			icon: o,
...
function Gn() {
	...
	].filter(Boolean).map((e, t) => Jn.call(this, "button", e, t, {
		defaultAction: { action: "toggle" },
		defaultHoldAction: { action: "more-info" },
		getIconColor: $n,
		getBackgroundColor: Qn
	})).filter(Boolean);
}
function Kn() {
	...
	return t.map((t, r) => {
		...
		let i = Jn.call(this, "curve_button", t, r, {
...
function qn() {
	...
	return e ? Jn.call(this, "action_button", e, 0, {
		key: "action_button",
		defaultAction: zn(e),
		defaultHoldAction: null,
		getIconColor: rr,
...
function Jn(e, t, n, r) {
	...
	if (!i) return null;
	let a = r.key || `${e}${n + 1}`, o = this._config?.[`${a}_state_template`], s = this._evaluateStateTemplate(o, t), c = o ? Lt(s) : this._getEntityActiveState(i), l = Zn.call(this, a, t), u = Xn.call(this, a, c), d = this._isImageIcon(u), f = this._buttonIconStates?.get(a), p = !!(f && f.entityId === t && f.isOn !== c);
	return this._buttonIconStates ||= /* @__PURE__ */ new Map(), this._buttonIconStates.set(a, {
		...
		svgForceColor: Yn.call(this, a, c),
		animateIcon: p,
		isImage: d
	};
}
function Yn(e, t) {
	if (Zn.call(this, e) !== "custom") return !0;
...
function Xn(e, t) {
	...
	return Zn.call(this, e) === "entity" ? "" : (t ? r : i) || n || "";
}
function Zn(e, t = "") {
	let n = this._config?.[`${e}_icon_source`], r = !!(t || this._config?.[e]);
...
function Qn(e, t, n) {
	if (n) return this._computeButtonBackground(er.call(this, e, t));
	let r = this._config[`${e}_off_color`] || "theme";
	return !r || r === "theme" ? "rgba(var(--color-theme),0.05)" : F(r, 10);
}
function $n(e, t, n) {
	if (n) return this._computeFullColor(er.call(this, e, t));
	let r = this._config[`${e}_off_color`] || "theme";
...
function tr(e, t, n) {
	...
	return r === "theme" ? n ? "rgba(var(--color-theme),0.7)" : "rgba(var(--color-theme),0.2)" : n ? this._computeFullColor(r) : F(r, 40);
}
function nr(e, t, n) {
	let r = n ? this._config[`${e}_on_color`] : this._config[`${e}_off_color`];
	return r && r !== "theme" ? ir.call(this, e, t, n, r) : tr.call(this, e, t, n);
}
function rr(e, t, n) {
	let r = n ? this._config[`${e}_on_color`] : this._config[`${e}_off_color`];
	return r && r !== "theme" ? ir.call(this, e, t, n, r) : tr.call(this, e, t, n);
...
function ir(e, t, n, r) {
	return n ? $n.call(this, e, t, !0) : r.startsWith("rgba(") ? r : F(r, 40);
}
function ar(e = {}, t, n) {
...
var or = {
	...
	constructor(e) {
		if (super(e), this.it = E, e.type !== or.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
var { I: mr } = Le, hr = (e) => e, gr = () => document.createComment(""), _r = (e, t, n) => {
	let r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
	if (n === void 0) n = new mr(r.insertBefore(gr(), i), r.insertBefore(gr(), i), e, e.options);
	else {
	...
	return n;
}, B = (e, t, n = e) => (e._$AI(t, n), e), vr = {}, yr = (e, t = vr) => e._$AH = t, br = (e) => e._$AH, xr = (e) => {
	e._$AR(), e._$AA.remove();
}, Sr = (e, t, n) => {
	let r = /* @__PURE__ */ new Map();
	for (let i = t; i <= n; i++) r.set(e[i], i);
	return r;
}, Cr = sr(class extends cr {
	constructor(e) {
	...
	update(e, [t, n, r]) {
		...
		else if (s[d] === o[m]) c[m] = B(i[d], a[m]), _r(e, c[m + 1], i[d]), d++, m--;
		else if (s[f] === o[p]) c[p] = B(i[f], a[p]), _r(e, i[d], i[f]), f--, p++;
		else if (l === void 0 && (l = Sr(o, p, m), u = Sr(s, d, f)), l.has(s[d])) if (l.has(s[f])) {
			let t = u.get(o[p]), n = t === void 0 ? null : i[t];
			if (n === null) {
				let t = _r(e, i[d]);
				B(t, a[p]), c[p] = t;
			} else c[p] = B(n, a[p]), _r(e, i[d], n), i[t] = null;
			p++;
		} else xr(i[f]), f--;
		else xr(i[d]), d++;
		for (; p <= m;) {
...
function V(e, t) {
	return Array.isArray(t) ? zr(e, t.map((t) => V(e, t))) : e._t ? e._t(t) : t;
}
function zr(e, t) {
	return (e?.hass?.locale?.language || e?.hass?.language || "en").toLowerCase().startsWith("en") ? t.map((e, t) => t === 0 ? e : Br(e)).join(" ") : t.join(" ");
}
function Br(e = "") {
...
function Ur(e, t, n) {
    ...
    <div class="field">
      ...
      >
        ...
        ${o === "files" ? qr.call(this, t, r) : Kr.call(this, t, r)}
      </div>
    </div>
  `;
}
...
function Wr(e = {}, { sourceKey: t = "main_entity_icon_source", entityKey: n = "main_entity", areaKey: r = "area", allowArea: i = !1, allowNone: a = !1, customIconKeys: o = [] } = {}) {
...
async function Gr(e = "") {
	...
	let [n, r] = await Promise.all([ai(), oi()]);
	this._orbitIconFiles = mi(n), this._localIconFiles = mi([t?.source === "local" || !t?.source ? t : null, ...r]), this._orbitIconFilesLoading = !1, this._localIconFilesLoading = !1, this.requestUpdate();
}
function Kr(e, t) {
	return w`
    <ha-icon-picker
...
function qr(e, t) {
	let n = this._orbitIconFiles || [], r = this._localIconFiles || [], i = Jr([...n, ...r]);
    ...
    <ha-generic-picker
      .value=${t && this._isImageIcon(t) ? t : ""}
      .getItems=${(e) => Xr(i, e)}
      .rowRenderer=${(e) => Zr.call(this, e)}
      .valueRenderer=${(e) => Qr.call(this, i.find((t) => t.id === e))}
...
function ei(e) {
	...
	if (!n) return w``;
	let r = this._getInlineSvg ? this._getInlineSvg(n) : "", i = this.hass?.themes?.darkMode ?? this.hass?.selectedTheme?.dark ?? !1, a = ti(), o = ni(i);
	return w`
    <span
...
function ri(e) {
	if (!e) return "";
	let t = ii(e.replace(/<\?xml[^>]*>/gi, "").trim()), n = t.match(/<svg\b[^>]*>/i)?.[0];
	if (!n) return t;
	let r = [
		"display:block",
		"flex:none",
...
async function ai() {
	return hn.filter(ui).map((e) => di(e, "orbit"));
}
async function oi() {
	let e = Array.isArray(window.ORBIT_ICON_FILES) ? window.ORBIT_ICON_FILES : [], t = await si([
...
async function si(e) {
	for (let t of e) try {
		...
		if (Array.isArray(r)) return r.filter(ui).map((e) => di(e));
	} catch {}
	return [];
}
async function ci() {
...
function hi(e, t) {
	return Array.isArray(t) ? gi(e, t.map((t) => hi(e, t))) : e._t ? e._t(t) : t;
}
function gi(e, t) {
...
function G(e, t, n) {
	return Array.isArray(t) ? Ci(e, t.map((t) => G(e, t, n))) : e._t ? e._t(t, n) : t;
}
function Ci(e, t) {
...
function Ti(e, t, n) {
	...
	return Ei.call(this, e, t, r, (e) => this._handleConfigUpdate(t, e), n);
}
function Ei(e, t, n, r, i) {
	Ri.call(this);
	let a = Di.call(this, n, i), o = aa(n || a), s = this._colorPickerKey === t && this._colorPickerTab || o;
	return w`
    <div class="field">
      <div class="color-row">
        <div
...
function ki(e, t, n, r = t, i = "") {
	let a = t || r, o = aa(a) === "theme" ? Hi(a) || "theme" : "", s = Li.call(this), c = Ai.call(this, s, o);
	return w`
    <div
    ...
    >
      <ha-generic-picker
        .getItems=${ji.call(this, i, c)}
        .label=${e ? G(this, e) : ""}
        .value=${o}
        .rowRenderer=${(e) => Mi.call(this, e)}
        .valueRenderer=${(e) => Ni.call(this, c.find((t) => t.id === e))}
...
function Ai(e, t) {
	return !t || e.some((e) => e.id === t) ? e : [...e, Bi.call(this, {
		id: t,
		source: "theme"
	})];
}
...
function Ii() {
	...
	for (let n of ia) {
		let r = Bi.call(this, n);
		!r || t.has(r.id) || (t.add(r.id), e.push(r));
	}
	for (let n of Ui.call(this)) {
		let r = Bi.call(this, n);
		!r || t.has(r.id) || (t.add(r.id), e.push(r));
	}
	return e;
...
function Ri() {
	...
	let t = () => {
		this._themeColorWarmupScheduled === e && (Li.call(this), this._themeColorWarmupScheduled = "");
	};
...
function zi() {
	return `${this?.hass?.locale?.language || this?.hass?.language || ""}|${this?.hass?.selectedTheme?.theme || this?.hass?.themes?.theme || ""}|${this?.hass?.themes?.darkMode ?? this?.hass?.selectedTheme?.dark ?? ""}|${Wi.call(this)}`;
}
function Bi(e) {
	let t = Vi(typeof e == "string" ? { id: e } : e), n = ea(t.id), r = n && ta(t.id), i = !r && (t.source === "theme" || Qi.call(this, t.id)), a = t.label ? G(this, t.label) : na.call(this, t.id);
	return {
		id: t.id,
		primary: a,
...
function Ui() {
	return Gi.call(this).map((e) => Ji(e)).filter(Yi).map((e) => ({
		id: e,
		source: "theme"
	})).sort((e, t) => na.call(this, e.id).localeCompare(na.call(this, t.id), this?.hass?.locale?.language || this?.hass?.language || void 0, { sensitivity: "base" }));
}
function Wi() {
	return Ki.call(this).map(([e, t]) => `${e}:${t}`).join(",");
}
function Gi() {
	return Ki.call(this).map(([e]) => e).sort();
}
function Ki() {
	let e = /* @__PURE__ */ new Set(), t = [], n = qi.call(this);
	for (let [r, i] of Object.entries(n)) {
		let n = r.toLowerCase();
		Xi(n, i) && (e.has(n) || (e.add(n), t.push([n, i])));
	}
...
function Xi(e, t) {
	return !e || !(e.startsWith("color-") || e.startsWith("google-") || e.endsWith("-color") || e.includes("-color-")) ? !1 : Zi(t);
}
function Zi(e) {
...
function Qi(e) {
	let t = new Set(Gi.call(this));
	return $i(e).some((e) => t.has(e));
}
function $i(e) {
	let t = Hi(e);
	if (!t) return [];
...
function K(e, t) {
	return la(e?.hass, t) || ua[t] || t;
}
function sa(e, t) {
	return da(e?.hass, t) || t;
}
function ca(e) {
	e.stopPropagation();
}
...
function pa(e, t, n, { extraActions: r = [] } = {}) {
	let i = this._config?.[t], a = typeof n == "object" ? n : { action: n || "none" }, o = i && typeof i == "object" ? Ia(i, a) : a, s = o.action || a.action || "none", c = new Set(r.map((e) => e.id)), l = [...r, ...Da(this).filter((e) => !c.has(e.id))];
	return w`
    <div class="field action-field">
      <div class="action-picker">
        <ha-generic-picker
          ...
          .getItems=${() => l}
          .rowRenderer=${(e) => Oa(e)}
          .valueRenderer=${(e) => ka(l.find((t) => t.id === e))}
          .notFoundLabel=${G(this, "No matching actions")}
          .noSort=${!0}
          @value-changed=${(e) => {
		e.stopPropagation();
		let n = Ea(e) || "none";
		this._updateConfig({ [t]: Fa(this, n, o) }), this.requestUpdate?.();
	}}
        ></ha-generic-picker>
      </div>

      ${s === "navigate" ? ja.call(this, t, o) : ""}

      ${s === "call-service" ? Ma.call(this, t, o) : ""}

      ${s === "url" ? Na.call(this, t, o) : ""}

      ${s === "popup" ? Pa.call(this, t, o) : ""}
    </div>
  `;
}
function q({ interactions: e = [], title: t = "Interactions", expanded: n = !1, context: r = {}, config: i = this._config, onChange: a } = {}) {
	...
	let s = o.filter((e) => ma(i, e)), c = o.filter((e) => !s.includes(e)), l = [{
		...
		schema: [...s.map((e) => ha(e, r, i, this)), {
			name: "",
			type: "optional_actions",
			flatten: !0,
			schema: c.map((e) => ha(e, r, i, this))
		}]
	}], u = ga(i, o);
	return w`
    <ha-form
...
function ma(e = {}, t) {
	return t.defaultVisible && !xa(e?.[t.key]);
}
function ha(e, t, n, r) {
	let i = ba(e.defaultAction), a = n?.[e.key];
...
function ga(e = {}, t) {
	return t.reduce((t, n) => {
		...
		let i = e?.[n.key] || (n.displayDefaultValue ? Ca(n.defaultAction) : void 0);
		return i && typeof i == "object" && i.action !== "popup" && (!xa(i) || ba(n.defaultAction) !== "none") && (t[r] = wa(i)), t;
	}, {});
}
function _a(e, t, n = {}) {
	return t.reduce((t, r) => {
		...
		let a = n?.[r.key], o = Ta(va(e[i], a), r.defaultAction);
...
function La({ value: e = "", includeDomains: t, excludeDomains: n, multiple: r = !1, onValueChanged: i, filterOptions: a, activeFilter: o = "all", className: s = "entity-picker" } = {}) {
	let c = a?.length ? a.map((e) => ({
		...e,
		label: Ra.call(this, e)
	})) : null, l = c ? Ba(c) : t;
	return r ? w`
      <ha-selector
        class=${s}
...
function Ra(e) {
	if (e.haDomains?.length) {
		let t = e.haDomains.map((e) => za(this?.hass, e)).filter(Boolean);
...
var Va = !1;
function Ha({ value: e, includeDomains: t, excludeDomains: n, filters: r, activeFilter: i, className: a, onValueChanged: o }) {
	$a();
	let s = r.map((e) => ({
		id: e.value,
		label: e.label
    ...
    <ha-generic-picker
      ...
      .valueRenderer=${(e) => Ga.call(this, e)}
      .rowRenderer=${Ka}
      .sections=${s}
...
function Ua({ search: e, section: t, filters: n, includeDomains: r, excludeDomains: i }) {
	...
	}).map((e) => Wa.call(this, e)).filter((e) => qa(e, c)).sort(Ja);
}
function Wa(e) {
	let t = Ya(e), n = Za(e.entity_id), r = Xa(this.hass, e);
	return {
		id: e.entity_id,
		primary: t,
		secondary: r,
...
function Ga(e) {
	let t = this.hass?.states?.[e], n = t ? Ya(t) : e, r = t ? Xa(this.hass, t) : void 0;
	return w`
...
function no({ value: e = "", onValueChanged: t, className: n = "entity-picker" } = {}) {
	return w`
    <ha-generic-picker
      class=${n}
      .hass=${this.hass}
...
function ro() {
	return Object.values(this.hass?.areas || {}).map((e) => io.call(this, e)).sort(co);
}
function io(e) {
	let t = e.name || e.area_id, n = so(this.hass, e);
	return {
		id: e.area_id,
		primary: t,
		secondary: n,
...
function ao(e) {
	let t = this.hass?.areas?.[e], n = t ? io.call(this, t) : {
		id: e,
		primary: e,
...
function fo(e) {
	e._editorPopoverCloseHandler || (e._editorPopoverCloseHandler = (t) => {
		!e._iconPickerKey && !e._colorPickerKey || mo(t.composedPath?.() || []) || (e._iconPickerKey = "", e._colorPickerKey = "", e._iconFilePickerOpen = !1, e._iconFileSearch = "", e._themeColorPickerOpen = !1, e._themeColorSearch = "", e.requestUpdate?.());
...
function go(e) {
	let t = e?.toString().trim();
	return t && (bo(t) || xo(t) || _o(t)) || "#ffffff";
}
function _o(e, t = /* @__PURE__ */ new Set()) {
	let n = e?.toString().trim().toLowerCase().replace(/[^a-z0-9-_]/g, "");
	if (!n || t.has(n)) return "";
	t.add(n);
	let r = dt(n), i = ut(n) ? yo(r) : "", a = ct(n) ? yo(`${n}-color`) : "", o = yo(n), s = n.startsWith("color-") ? "" : yo(`color-${n}`);
	return vo(i, t) || vo(a, t) || vo(o, t) || vo(s, t) || "";
}
function vo(e, t) {
	let n = e?.trim();
	if (!n) return "";
...
function xo(e) {
	...
	if (t) return So(Number(t[1]), Number(t[2]), Number(t[3]));
	let n = e.match(/^\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*$/i);
	return n ? So(Number(n[1]), Number(n[2]), Number(n[3])) : "";
}
function So(e, t, n) {
...
function wo({ label: e = "Name", valueKey: t, legacyValueKey: n = "", entityKey: r = "main_entity", areaKey: i = "area", defaultType: a = "", defaultMode: o = "composed", modeKey: s = t, templateKey: c = "", templateLabel: l = "Template" } = {}) {
	return To.call(this), c || !customElements.get("ha-entity-name-picker") ? Eo.call(this, {
		label: e,
		valueKey: t,
		entityKey: r,
		areaKey: i,
    ...
    <div class="field name-picker-field">
      <ha-entity-name-picker
        ...
        @value-changed=${(e) => {
		e.stopPropagation(), Vo.call(this, {
			valueKey: t,
			legacyValueKey: n,
			value: Ho(e.detail.value, this._config, {
				entityKey: r,
				areaKey: i,
				defaultType: a
			})
...
function Eo(e) {
	let t = jo(this._config, Mo(this, e.modeKey), e);
	return w`
    <div class="field name-picker-field name-picker-fallback">
      <div class="field-header">
		...
		if (No(this, e.modeKey, n), !(e.templateKey && (this._updateConfig({
			[e.valueKey]: void 0,
			...
			if (typeof Bo(this._config, e) != "string") {
				Vo.call(this, {
					valueKey: e.valueKey,
					legacyValueKey: e.legacyValueKey,
					value: void 0
      ...
      ${t === "template" ? this._renderTemplateInput(e.templateLabel, e.templateKey, { hideLabel: !0 }) : t === "custom" ? Do.call(this, e) : Oo.call(this, e)}
    </div>
  `;
}
function Do(e) {
    ...
    <ha-selector
      ...
      .hass=${this.hass}
      .selector=${{ text: {} }}
      .value=${typeof Bo(this._config, e) == "string" ? Bo(this._config, e) : ""}
      @value-changed=${(t) => {
		t.stopPropagation(), Vo.call(this, {
			valueKey: e.valueKey,
			legacyValueKey: e.legacyValueKey,
...
function Oo(e) {
	let t = Po(this._config, e), n = Io.call(this, t, e);
	return w`
    <ha-generic-picker
      ...
      @value-changed=${(n) => {
		n.stopPropagation();
		let r = Lo(n.detail.value);
		r && (No(this, e.modeKey, "composed"), Vo.call(this, {
			valueKey: e.valueKey,
			legacyValueKey: e.legacyValueKey,
			value: Ho([...t, r], this._config, e)
		}));
	}}
    >
      <div slot="field" class="name-picker-composed-field">
        ${t.map((n, r) => ko.call(this, n, r, t, e))}
...
function jo(e = {}, t, n) {
	if (n.templateKey && zo(e, n.templateKey)) return "template";
	let r = Bo(e, n);
...
function Fo(e) {
	return e ? e.type === "text" ? `"${e.text || ""}"` : e.type === "area" ? this._t("Area") : e.type === "entity" ? this._t("Entity") : $o(this, e.type) : "";
}
function Io(e = [], t) {
	let n = [], r = new Set(e.filter((e) => e?.type && e.type !== "text").map((e) => e.type)), i = t.areaKey && this._config?.[t.areaKey] ? this.hass?.areas?.[this._config[t.areaKey]] : null, a = Go.call(this, t), o = a ? this.hass?.states?.[a] : null;
...
function Bo(e = {}, t) {
	if (zo(e, t.valueKey)) return e[t.valueKey];
	if (t.legacyValueKey && zo(e, t.legacyValueKey)) return e[t.legacyValueKey];
}
function Vo({ valueKey: e, legacyValueKey: t, value: n }) {
...
function Ho(e, t = {}, n) {
	if (!(!e || Array.isArray(e) && e.length === 0) && !(n.defaultType && Uo(t, n) && Wo(e, n.defaultType))) return e;
}
function Uo(e = {}, t) {
...
function ls() {
	let e = zn(this._config?.action_button);
	return w`
    <div class="section">
...
function ds(e, t, n, r = {}, i = {}) {
    ...
    <div class="sub-section selected-button-section">
      ...
      ${i.showColors ? w`
            <div class="color-pair">
              ${hs.call(this, ["Active", "Color"], `${e}_on_color`)}
              ${hs.call(this, ["Inactive", "Color"], `${e}_off_color`)}
            </div>
          ` : ""}
...
function Y(e, t, n = {}) {
	let r = ks(e), i = r.replace("_", "-"), a = r.split("-")[0], o = Es(e, t) || Os(r, t) || Os(i, t) || Os(a, t) || Ts.en[t] || t;
...
var As = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), fo(this), this._updateDocumentationContext();
	}
	disconnectedCallback() {
		po(this), super.disconnectedCallback();
	}
	_getColorStyle(e) {
		return ho(e);
	}
	...
	_updateConfig(e) {
		...
		let n = xi(this._config, t), r = Wr(n, {
			sourceKey: "main_entity_icon_source",
			entityKey: "main_entity",
			areaKey: "area",
			allowArea: !0,
		...
		(i || a) && (n.main_entity_icon = void 0), this._config = zs(xi(n, {})), this.dispatchEvent(new CustomEvent("config-changed", {
	...
	_handleEntityUpdate(e, t) {
		...
		this._updateConfig(W("main_entity", Ns));
	}
	_clearStatusEntity(e) {
		this._updateConfig(Si(e, Ps));
	}
	_clearButtonEntity(e) {
		this._updateConfig(Si(e, Fs));
	}
	_clearCurveButtonEntity(e) {
		this._updateConfig(Si(e, Is));
	}
	_clearActionButtonEntity(e) {
		this._updateConfig(Si(e, Ls));
	}
	...
	_renderColorControl(e, t, n, r, i = n) {
		return Ei.call(this, e, t, n, r, i);
	}
	_renderIconInput(e, t, n = "mdi:lightbulb or icon.svg") {
		return Ur.call(this, e, t, n);
	}
	...
	_updateDocumentationContext() {
		Dt(this, this._config?.type || "orbit-area-card-dev", this._activeSection || "card");
	}
	_renderActiveSection() {
		let e = js.find((e) => e.key === this._activeSection) || js[0];
...
customElements.define("orbit-area-card-dev-editor", As), customElements.define("orbit-room-card-dev-editor", Ms);
var Ns = [
...
var Bs = class extends k {
	...
	willUpdate(e) {
		return (e.has("_config") || e.has("hass")) && Pt.call(this, this._getTemplateEntries()), Bn.call(this, e);
	}
	disconnectedCallback() {
		Ft.call(this), this._cancelLongPress(), this._clearDoubleTapTimer(), super.disconnectedCallback();
	}
	shouldUpdate(e) {
		return jn.call(this, e, this._getRelevantEntities(), { hasTemplates: Mn(this._config) });
	}
	...
	_getCardName(e = "Card") {
		return _t(this._config, this.hass, e);
	}
	formatState(e) {
		return en(e);
	}
...
function Ks({ config: e = {}, count: t = 1, wrapKey: n = "wrap", perRowKey: r, defaultColumns: i = 3 }) {
...
var Qs = new Map(Js.map((e) => [e.value, e]));
function $s(e = "") {
	return Qs.get(e) || {
		value: e,
...
function ec(e = {}) {
	let t = Z(e), n = e.domain ? $s(e.domain) : void 0;
	if (t === "area_count" && n?.requiresDeviceClass && oc(e).length === 0) throw Error(`Orbit Status Badge (Dev) requires "device_class" for domain "${e.domain}".`);
	return t;
}
function tc(e = {}) {
...
function lc(e, t = {}) {
	let n = dc(t), r = t.domain || "", i = $s(r), a = oc(t);
	return !e || !n.length || !r || i.requiresDeviceClass && !a.length ? [] : Object.values(e.states || {}).filter((o) => o.entity_id.startsWith(`${r}.`) && n.includes(Fn(e, o.entity_id)) && (!i.requiresDeviceClass || a.includes(sc(o, r))) && !rc(e, o.entity_id, t));
}
function uc(e, t = {}) {
...
function fc(e, t = {}) {
	return dc(t).map((t) => e?.areas?.[t]?.name || t).filter(Boolean).join(", ");
}
function pc(e, t = {}) {
...
function mc(e, t = !1) {
	...
	let i = hc(e.state), a = t ? "active" : "inactive";
	return [
...
function Pc(e, t) {
	let n = Fn(e, t?.entity_id) || t?.attributes?.area_id || "";
...
function Vc(e) {
	return `color:${yn(e) || mc(e, !0)};--mdc-icon-size:36px`;
}
function Hc(e) {
...
function il() {
	...
	this._cardName = o ? vt(this._config.name, this._config, this.hass) : Q(i, "friendly_name") || Q(r, "friendly_name") || e || t || Y(this.hass, "Person");
	...
	this._personPicture = Q(i, "entity_picture") || Q(r, "entity_picture") || "", this._personZoneIcon = al.call(this, r, i), this._personBattery1 = sl.call(this, this._config.battery_entity_1), this._personBattery2 = sl.call(this, this._config.battery_entity_2), this._icon = Q(i, "icon") || Q(r, "icon") || "mdi:account", this._navigationPath = Yc(this._config, r), this._nameColor = this._computeFullColor(d), this._statusColor = this._computeFullColor(d), this._circleColor = this._computeCircleColor(d), this._iconColor = u ? this._computeFullColor(d) : this._computeIconColor(d), this._iconSvgForceColor = !0;
}
function al(e, t) {
...
function pl() {
	let e = ml(this), t = Z(e);
	if (t === "area_count") return e.tap_action?.action ? e.tap_action : { action: X };
...
function vl(e = 0) {
	let t = this._statusItems?.[e];
	return t?.entity_tap_action?.action && t.entity_tap_action.action !== "none" ? t.entity_tap_action : this._config.entity_tap_action?.action && this._config.entity_tap_action.action !== "none" ? this._config.entity_tap_action : Z(t) === "area_count" ? {
		action: X,
		status_index: e
...
function Cl(e) {
    ...
    >
      ...
      <div class="badge-interactions-content">
        ${pa.call(this, "Tap behavior", "tap_action", t, e === "area_count" ? { extraActions: [n] } : void 0)}
        ${pa.call(this, "Hold behavior", "hold_action", "none")}
        ${pa.call(this, "Double tap behavior", "double_tap_action", "none")}
      </div>
    </ha-expansion-panel>
  `;
}
...
function Tl({ stateSource: e, domainConfig: t, deviceClassOptions: n, badgeMode: r, showInactiveTemplate: i = r, showNameTemplate: a = !r, preserveStateConfig: o = !1, renderEntityPicker: s, areaMultiple: c = !1, renderAreaPicker: l }) {
	let u = this._config?.domain || "", d = oc(this._config), f = r ? this._config?.card_visibility || "always" : e, p = r ? [
		{
		...
		updateConfig: (e) => this._updateConfig(e)
            ...
            <div class="field">
              <ha-generic-picker
                ...
                use-top-label
                .getItems=${() => Ol.call(this)}
                .valueRenderer=${(e) => kl.call(this, e)}
                .rowRenderer=${Al}
		...
		this._handleConfigUpdate("device_class", n.length ? n : void 0);
          ...
          ` : f === "template" ? w`
              ...
              <div class="field">
                ...
                ></ha-selector>
                ${El.call(this, this._config?.active_template, this._config?.entity || "")}
              </div>
              ${i ? w`
                    <div class="field">
                      <ha-selector
                      ...
                      ></ha-selector>
                      ${El.call(this, this._config?.inactive_template, this._config?.entity || "")}
                    </div>
                  ` : ""}
              ${a ? w`
                    <div class="field">
                      ...
                      ></ha-selector>
                      ${El.call(this, this._config?.name_template)}
                    </div>
                  ` : ""}
            ` : ""}
    </div>
...
function El(e, t = "") {
	let n = It.call(this, e, t);
	return n ? w`<ha-alert alert-type="error">${n}</ha-alert>` : "";
}
function Dl() {
	let e = tc(this._config), t = e.some((e) => e.type === "hidden"), n = e.filter((e) => e.type === "label").map((e) => e.label), r = ({ hidden: e = t, labels: r = n } = {}) => {
		this._updateConfig({ hide: nc([...e ? [{ type: "hidden" }] : [], ...r.map((e) => ({
			type: "label",
			label: e
		}))]) });
	};
...
function jl({ config: e = this._config || {}, updateConfig: t = (e) => this._updateConfig(e) } = {}) {
...
function Ml() {
	let e = this._config?.mode || "standard", t = e === "icon_only", n = e === "person", r = n ? "entity" : Z(this._config), i = r === "area_count" ? X : r === "template" || t || n ? "more-info" : "navigate", a = this._config?.tap_action?.action || i, o = r === "area_count" ? X : t || n ? a : "more-info";
	return w`
    <div class="section">
      <div class="field editor-button-toggle-field">
        <div class="field-header">
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ button_toggle: { options: Hl.call(this) } }}
            .value=${e}
    ...
    ${t ? Pl.call(this, {
		...
		"Color"
                ...
                `) : w`
                  ${Fl.call(this, this._config, "entity", (e) => this._updateConfig(e), (e) => this._handleEntityUpdate("entity", e))}
                  ${Il.call(this, w`
                    ${Nl.call(this)}
                    <div class="color-pair">
                      ${this._renderColor([
		...
		interactions: [
			{
				...
				defaultAction: i,
				defaultVisible: !0,
				customDefaultLabel: i === "Current state" ? X : void 0
			},
			{
				key: "hold_action",
				formKey: "hold_action",
...
function Pl({ cardActionDefault: e, mainEntityActionDefault: t }) {
	let n = this._getStatusItems(), r = Math.min(this._selectedStatusIndex || 0, n.length - 1), i = n[r] || {}, a = Z(i), o = a === "area_count", s = o ? X : e, c = o ? X : t, { itemsPerRow: l, shouldWrapTabs: u, showTabScrollHint: d } = xl({
		config: this._config,
		itemCount: n.length,
		defaultPerRow: 3
	});
    ...
    <div class="section">
      ...
      ${Fl.call(this, i, "entity", (e) => this._updateStatusItem(r, e), (e) => this._updateStatusItem(r, { entity: e }))}
      ...
      ${Il.call(this, w`
        ...
        ${o ? "" : w`
              ${Rl.call(this, "State template", "state_template", r, i)}
            `}
      `)}
...
function Fl(e, t, n, r) {
	let i = {
		...
		_updateConfig: (e) => n(Ll(e, t)),
		_handleConfigUpdate: (e, r) => n(Ll({ [e]: r }, t))
	};
	return w`
    <ha-expansion-panel
...
`, Gl = Symbol.for("orbit-status-card-dev-preview-selected-index"), Kl = class extends k {
	static svgCache = R;
	static properties = {
		hass: { attribute: !1 },
		_config: { state: !0 },
	...
	connectedCallback() {
		super.connectedCallback(), fo(this), Dt(this, "orbit-status-card-dev");
	}
	disconnectedCallback() {
		po(this), super.disconnectedCallback();
	}
	...
	setConfig(e) {
		...
		this._config = eu(t || {}), this._selectedStatusIndex = Math.min(this._selectedStatusIndex || 0, this._getStatusItems(this._config).length - 1), n && this._queueConfigMigration();
	}
	_queueConfigMigration() {
		this._configMigrationQueued || (this._configMigrationQueued = !0, Promise.resolve().then(() => {
			this._configMigrationQueued = !1, this.dispatchEvent(new CustomEvent("config-changed", {
	...
	_updateConfig(e) {
		this._config = eu(xi(this._config, e)), this.dispatchEvent(new CustomEvent("config-changed", {
	...
	_getPreviewConfig(e = this._config) {
		return {
			...e,
			[Gl]: this._selectedStatusIndex || 0
		};
	}
	_handleInput(e, t) {
		this._updateConfig({ [e]: t.target.value });
	...
	_handleEntityUpdate(e, t) {
		...
		if (e === "tracker_entity") {
			this._updateConfig(W("tracker_entity", Zl));
			return;
		}
		this._handleConfigUpdate(e, t);
	}
	_clearMainEntity() {
		if (this._config?.mode === "person") {
			this._updateConfig(W("entity", Xl));
			return;
		}
		this._updateConfig(W("entity", Jl));
	}
	...
	_addStatusItem() {
		...
		this._selectedStatusIndex = e.length, this._updateConfig(U(Yl, { entities: [...e, { entity: "" }] }));
	}
	_duplicateStatusItem(e) {
		let t = this._getStatusItems(), n = t[e];
		if (!n) return;
		let r = [...t];
		r.splice(e + 1, 0, structuredClone(n)), this._selectedStatusIndex = e + 1, this._updateConfig(U(Yl, { entities: r }));
	}
	_removeStatusItem(e) {
	...
	_moveStatusItem(e, t) {
		...
		i.splice(r, 0, a), this._selectedStatusIndex = r, this._updateConfig(U(Yl, { entities: i }));
	}
	_updateStatusItem(e, t) {
		...
		if (t.entity === "" && Z(r) === "entity" && ql(r), Array.isArray(this._config?.entities)) {
			let t = [...n];
			t[e] = r;
			let i = { entities: t };
			t.length > 1 && Object.assign(i, U(Yl)), this._updateConfig(i);
			return;
		}
			...
			interactions: [
				{
					...
					defaultAction: n,
					defaultVisible: !0,
					customDefaultLabel: n === "Current state" ? X : void 0
				},
				{
					key: "hold_action",
					formKey: "hold_action",
...
customElements.define("orbit-status-card-dev-editor", Kl);
function ql(e) {
	Object.assign(e, U(Jl));
}
var Jl = [
	...Ys,
	"accent_on_color",
...
function eu(e) {
	let t = au(e);
	t.mode !== "icon_only" && delete t.entities, tu(t), ru(t), iu(t);
	let n = {}, r = /* @__PURE__ */ new Set();
	return $l.forEach((e) => {
		Object.prototype.hasOwnProperty.call(t, e) && (n[e] = e === "entities" && Array.isArray(t[e]) ? t[e].map(nu) : t[e], r.add(e));
...
function tu(e) {
	...
	e.entities = e.entities.map((e) => {
		...
		return n.state_source === void 0 && (Object.assign(n, t), ru(n)), n;
	}), Ys.forEach((t) => {
		delete e[t];
	});
}
...
function su() {
	let e = this._config?.mode || "standard", t = this._statusItems || [], n = e === "icon_only" && t.length > 1, r = Math.max(t.length, 1), i = this._getStatusColumnCount(r), a = this._getStatusRowCount(r), o = mu(this._statusText), s = this._isImageIcon(this._icon) ? this._resolveIconPath(this._icon) : "", c = s ? this._getInlineSvg(s, this._iconSvgForceColor) : "";
	return w`
    <ha-card
    ...
    >
      ...
      >
        ...
        >
          ${e === "person" ? uu.call(this) : this._isImageIcon(this._icon) ? w`
                <div
                  class="main-image-icon"
                >
              ...
              ` : w`
                ...
                ></ha-icon>
            `}
          ${fu.call(this, this._mainStateObj)}
        </div>
    ...
    <div class="status-icon-grid">
      ${hu(e, t).map((e, n) => w`
        <div class="status-icon-row">
          ${e.map((e, r) => lu.call(this, e, n * t + r))}
...
function lu(e, t) {
	let n = this._config?.[Gl], r = Number.isInteger(n) && n === t ? "orbit-editor-preview-selected" : "", i = mu(e.statusText), a = this._isImageIcon(e.icon) ? this._resolveIconPath(e.icon) : "", o = a ? this._getInlineSvg(a, e.svgForceColor) : "", s = w`
...
function uu() {
    ...
    <div class="person-main-icon">
      ...
      ${du.call(this, "zone", this._personZoneIcon || "mdi:home-minus", this._computeFullColor("blue"))}

      ${this._personBattery1 ? du.call(this, "battery-1", null, this._personBattery1.color, this._personBattery1.entityId, this._personBattery1.stateObj) : ""}

      ${this._personBattery2 ? du.call(this, "battery-2", null, this._personBattery2.color, this._personBattery2.entityId, this._personBattery2.stateObj) : ""}
    </div>
  `;
}
function du(e, t, n, r = null, i = null) {
	let a = pu(i);
	return w`
    <span
...
`, bu = class extends k {
	...
	constructor() {
		super(), bc.call(this), this._activeEntitiesStatusIndex = 0;
	}
	static getConfigElement() {
	...
	getLayoutOptions() {
		if (this._config?.mode === "icon_only") {
			let e = el(this._config).length, t = xu(this._config, e);
			return {
	...
	willUpdate(e) {
		return (e.has("_config") || e.has("hass")) && Pt.call(this, this._getTemplateEntries()), $c.call(this, e);
	}
	disconnectedCallback() {
		Ft.call(this), this._clearMainIconHoldTimer(), this._clearStatusItemHoldTimer(), this._clearDoubleTapTimer(), wc.call(this), super.disconnectedCallback();
	}
	shouldUpdate(e) {
	...
	_renderActiveEntitiesDialog() {
		...
		return Wc.call(this, xc(uc(this.hass, e)));
	}
	_t(e, t) {
		return Y(this.hass, e, t);
	}
	...
	_handleMainEntityTap(e) {
		...
		!t && Z(n) !== "area_count" || M.call(this, e, t, this._getMainEntityTapAction() || this._getCardTapAction(), this._getMainEntityDoubleTapAction());
	}
	_handleMainEntityDoubleTap(e) {
	...
	_getTemplateEntries() {
		if (this._config?.mode === "icon_only") return el(this._config).flatMap((e) => (Z(e) === "area_count" ? [] : [
			e.state_template,
			e.active_template,
			e.inactive_template,
			e.name_template
	...
	_getRelevantEntities() {
		return this._config?.mode === "icon_only" ? el(this._config).flatMap((e) => Z(e) === "area_count" ? pc(this.hass, e) : [e.entity]) : Z(this._config) === "area_count" ? pc(this.hass, this._config) : [
			this._config?.entity,
...
function Tu(e) {
	!e.has("_config") && !e.has("hass") || (this._actions = Eu(this._config).map((e) => Du.call(this, e)));
}
function Eu(e = {}) {
	return Array.isArray(e.entities) && e.entities.length ? e.entities.map((e) => typeof e == "string" ? { entity: e } : e || {}) : [{
...
function Du(e) {
	let t = e.entity || e.main_entity, n = t && this.hass ? this.hass.states[t] : null, r = e.accent_color || this._config.accent_color || "theme", i = ku(n), a = this._computeCircleColor(r), o = i ? this._computeFullColor(r) : this._computeIconColor(r), s = Ou(e, t), c = s === "custom" && (e.main_entity_icon || e.icon) || "", l = s === "custom" && e.main_entity_icon ? "main_entity_icon" : s === "custom" && e.icon ? "icon" : "", u = c || "mdi:play-circle";
	return {
		...e,
		entityId: t,
		stateObj: n,
...
function Au() {
	let e = this._actions || [], t = Math.max(e.length, 1), n = this._getActionColumnCount(t), r = this._getActionRowCount(t), i = Mu(e, n);
	return w`
    <ha-card
...
`, zu = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), fo(this), Dt(this, "orbit-action-card-dev");
	}
	disconnectedCallback() {
		po(this), super.disconnectedCallback();
	}
	...
	_updateConfig(e) {
		this._config = Gu(xi(this._config, e)), this.dispatchEvent(new CustomEvent("config-changed", {
			detail: { config: this._config },
			bubbles: !0,
			composed: !0
		}));
	...
	_addActionItem() {
		...
		this._selectedActionIndex = e.length, this._updateConfig(U(Hu, { entities: [...e, { entity: "" }] }));
	}
	_removeActionItem(e) {
		let t = this._getActionItems();
		if (t.length <= 1) {
			this._updateConfig(W("main_entity", Vu));
			return;
		}
		let n = t.filter((t, n) => n !== e);
	...
	_moveActionItem(e, t) {
		...
		if (r < 0 || r >= n.length) return;
		let i = [...n], [a] = i.splice(e, 1);
		i.splice(r, 0, a), this._selectedActionIndex = r, this._updateConfig(U(Hu, { entities: i }));
	}
	_updateActionItem(e, t) {
		...
		if (t.entity === "" && Bu(r), Array.isArray(this._config?.entities)) {
			let t = [...n];
			t[e] = r;
			let i = { entities: t };
			...
			interactions: [
				{
					...
					formKey: "tap_action",
					label: "Tap behavior",
					defaultAction: zn(t.entity, "toggle"),
					defaultVisible: !0
				},
				{
					key: "hold_action",
...
customElements.define("orbit-action-card-dev-editor", zu);
function Bu(e) {
...
function Gu(e) {
	let t = {}, n = /* @__PURE__ */ new Set();
	return Wu.forEach((r) => {
		Object.prototype.hasOwnProperty.call(e, r) && (t[r] = r === "entities" && Array.isArray(e[r]) ? e[r].map(Ku) : e[r], n.add(r));
	}), Object.keys(e).forEach((r) => {
		n.has(r) || (t[r] = e[r]);
	}), t;
}
function Ku(e) {
	return !e || typeof e != "object" || Array.isArray(e) ? e : qu(e, Uu);
}
function qu(e, t) {
	let n = {}, r = /* @__PURE__ */ new Set();
	return t.forEach((t) => {
...
var Ju = class extends k {
	...
	getLayoutOptions() {
		let e = Eu(this._config).length, t = Yu(this._config, e);
		return {
	...
	shouldUpdate(e) {
		return jn.call(this, e, Eu(this._config).map((e) => e.entity || e.main_entity), { hasTemplates: Mn(this._config) });
	}
	_handleTap(e, t = 0) {
		if (this._longPressTriggered) {
			this._longPressTriggered = !1, this._stopEvent(e);
	...
	_getTapAction(e = 0) {
		let t = this._actions?.[e];
		return t?.tap_action?.action ? t.tap_action : this._config.tap_action?.action ? this._config.tap_action : zn(this._getActionEntityId(e), "toggle");
	}
	_getHoldAction(e = 0) {
		let t = this._actions?.[e];
...
function Qu(e = {}) {
	let t = e?.attributes || {};
	return {
		top: id(t.padding_top),
		right: id(t.padding_right),
		bottom: id(t.padding_bottom),
		left: id(t.padding_left)
	};
}
function $u(e = {}) {
	return Object.values(Qu(e)).some(Boolean);
}
function ed(e = {}) {
	return e?.attributes?.force_padding === !0;
}
function td(e = {}) {
	return $u(e) && (ed(e) || !rd(e?.card));
}
function nd(e = {}) {
	return ed(e) && $u(e);
}
function rd(e) {
	return Array.isArray(e) ? e.some((e) => rd(e)) : !e || typeof e != "object" ? typeof e == "string" ? /\bpadding(?:-(?:top|right|bottom|left))?\b/i.test(e) : !1 : Object.entries(e).some(([e, t]) => e.toLowerCase().includes("padding") || rd(t));
}
function id(e) {
	if (e == null || e === "") return "";
	let t = e.toString().trim();
...
function sd(e = {}) {
	let t = ud(e);
	return e?.attributes?.entity || fd(e?.attributes?.tap_action) || fd(e?.attributes?.hold_action) || fd(e?.attributes?.double_tap_action) || fd(t?.tap_action) || fd(t?.hold_action) || fd(t?.double_tap_action) || t?.entity || null;
}
function cd(e = {}, t = !1) {
	let n = ud(e), r = nd(e) ? dd(n) : n, i = r, a = [
		"tap_action",
		"hold_action",
		"double_tap_action"
	].filter((t) => A($(e, t)));
...
function dd(e) {
	return Array.isArray(e) ? e.map((e) => dd(e)) : !e || typeof e != "object" ? e : Object.entries(e).reduce((e, [t, n]) => (t.toLowerCase().includes("padding") || (e[t] = dd(n)), e), {});
}
function fd(e) {
...
function hd(e = {}, t = 0) {
	let n = e?.attributes || {}, r = gd(n.left, 0), i = gd(n.top, 0);
	return `${[
...
function xd(e = {}) {
	return [
		...
		Sd("--orbit-deck-tab-color", e.tab_color),
		Sd("--orbit-deck-tab-active-color", e.tab_active_color),
		Sd("--orbit-deck-tab-background-color", e.tab_background_color)
	].filter(Boolean).join("");
}
function Sd(e, t) {
	return t ? `${e}:${P(t)};` : "";
...
function Td(e = []) {
	return e.map((e) => {
		...
		let t = Qu(e.item), n = ed(e.item), r = td(e.item);
		return [
			e.index,
			e.kind || ld(e.item),
			ud(e.item)?.type || "",
...
function kd(e, t) {
	if (t) {
		e._orbitDeckSurfaceStyles ||= Object.fromEntries(Object.keys(Od).map((t) => [t, {
...
function jd(e) {
	e._orbitDeckSurfaceObserver || (e._orbitDeckSurfaceObserver = new MutationObserver(() => {
		e._orbitDeckSurfaceStyles && Ad(e);
...
function Id(e, t) {
	Ld(e, "padding-top", t.top), Ld(e, "padding-right", t.right), Ld(e, "padding-bottom", t.bottom), Ld(e, "padding-left", t.left);
}
function Ld(e, t, n) {
...
function Rd(e, t) {
	e._orbitDeckPadding = t, !e._orbitDeckPaddingObserver && (e._orbitDeckPaddingObserver = new MutationObserver(() => {
		e._orbitDeckPadding && Id(e, e._orbitDeckPadding);
...
function Ud(e) {
	let t = {}, n = /* @__PURE__ */ new Set();
	return Vd.forEach((r) => {
		Object.prototype.hasOwnProperty.call(e, r) && (t[r] = r === "decks" && Array.isArray(e[r]) ? e[r].map(Kd) : e[r], n.add(r));
	}), Object.keys(e).forEach((r) => {
		n.has(r) || (t[r] = e[r]);
	}), t;
}
...
function Kd(e) {
	...
	let t = {}, n = /* @__PURE__ */ new Set(), r = {
		...e,
		attributes: qd(e.attributes || {})
	};
	return e.badge?.type ? (r.badge = e.badge, delete r.card) : e.card?.type ? (r.card = e.card, delete r.badge) : (delete r.badge, delete r.card), Hd.forEach((e) => {
...
async function tf({ eventName: e, dialogTag: t, detail: n, huiView: r }) {
...
var uf = [
  ...
  `
], df = Symbol.for("orbit-deck-card-dev-preview-selected-index"), ff = class extends k {
	static properties = {
		hass: { attribute: !1 },
	...
	_updateConfig(e) {
		this._config = Ud(xi(this._config, e)), this._dispatchConfigChanged();
	}
	...
	_getPreviewConfig() {
		return {
			...this._config,
			[df]: this._selectedDeckIndex || 0
		};
	}
	_getDeckItems(e = this._config) {
		return Array.isArray(e?.decks) ? e.decks.map(Gd) : [];
	}
	_selectDeckItem(e) {
	...
	_renderDeckInteractions(e, t) {
		let n = t?.attributes || {}, r = Jd(t, "tap_action"), i = Jd(t, "hold_action"), a = Jd(t, "double_tap_action");
		return q.call(this, {
			expanded: !1,
			config: n,
			...
			interactions: [
				...
				},
				{
					...
					defaultAction: a,
					defaultVisible: Zd(a),
					displayDefaultValue: Zd(a)
				}
			],
			context: { entity_id: n.entity || Yd(t)?.entity }
		});
	}
	...
	async _loadNativeBadgeModule(e) {
		return tf.call(this, e);
	}
	_findElementInShadowRoots(e, t) {
		return nf.call(this, e, t);
	}
...
customElements.define("orbit-deck-card-dev-editor", ff);
//#endregion
...
kt({
	...
	cardClass: class extends k {
		...
		getLayoutOptions() {
			let e = ad(this._config), t = Math.max(e.length, 1), n = this._getColumnCount(t);
			return {
		...
		setConfig(e) {
			let t = Kt(e || {}), n = ["tabs", "overlay"].includes(t.config?.layout) ? t.config.layout : "wrap";
			this._config = {
				...t.config,
				layout: n
			};
			let r = ad(this._config), i = md(r), a = pd(r);
			Number.isInteger(e?.[df]) ? this._selectedIndex = Math.min(Math.max(0, e[df]), Math.max(0, r.length - 1)) : i === this._defaultSelectionKey ? this._selectedIndex = Math.min(this._selectedIndex || 0, Math.max(0, r.length - 1)) : (this._selectedIndex = a, this._defaultSelectionKey = i), this._scheduleCardBuild();
		}
		updated(e) {
		...
		_applyOverlayItemGeometry(e) {
			...
			if (i <= 0 || a <= 0) return;
			let o = n.item?.attributes || {}, s = ld(n.item) === "badge", c = _d(o.width), l = _d(o.height), u = vd(n.item) === "crop", d = yd(i, a, c, l, u);
		...
		async _scheduleCardBuild() {
			let e = ad(this._config), t = JSON.stringify(e.map((e, t) => ({
				kind: ld(e),
				config: cd(e, Dd(this._config, e, t))
			})));
			...
			let n = await this._loadCardHelpers(), r = e.map((e, t) => this._createDeckEntry(e, n, t, Dd(this._config, e, t)));
		...
		_disconnectDeckEntryObservers(e = this._deckCards) {
			this._deckEntryGeneration += 1, e.forEach((e) => {
				let t = e?.element;
				t && new Set([t, ...Nd(t)]).forEach((e) => {
					disconnectDeckCardSurfaceObserver(e), zd(e);
				});
			});
		}
		...
		_renderInteractiveDeckEntry(e) {
			let t = od(e?.item), n = Dd(this._config, e?.item, e?.index), r = this._config?.[df], i = Number.isInteger(r) && r === e?.index;
			return w`
      <div
    ...
    `;
		...
		_applyDeckPaddingToEntries() {
			let e = this._deckCards.map((e) => Dd(this._config, e.item, e.index) ? "flat" : "native").join(":"), t = `${Td(this._deckCards)}|surface:${e}`;
		...
		_applyDeckCardPadding(e, t = 0) {
			let n = e?.element;
			if (!n) return;
			let r = this._deckEntryGeneration, i = Qu(e.item), a = td(e.item);
			(n.updateComplete instanceof Promise ? n.updateComplete : Promise.resolve()).then(() => new Promise((e) => requestAnimationFrame(e))).then(() => {
				...
				let o = Nd(n), s = o[0] || null, c = Ed(this.renderRoot, e.index), l = Dd(this._config, e.item, e.index);
				if (!(!s && !c)) {
					...
					c && Fd(c, i, !1), s && Fd(s, i, a), a && s ? (Rd(s, i), requestAnimationFrame(() => {
						this._isDeckEntryActive(e, r) && (c && Fd(c, i, !1), Fd(s, i, !0));
					})) : s && zd(s);
				}
			}).catch(() => {});
		}
		_renderWrap(e) {
			let t = this._getVisibleDeckEntries(), n = this._deckCards.filter((e) => e.visible === !1), r = this._getColumnCount(t.length || 1), i = Cd(t, r);
			return w`
      <ha-card
    ...
    `;
		...
		_renderTabs(e) {
			let t = Math.min(this._selectedIndex || 0, Math.max(0, e.length - 1)), n = this._getVisibleDeckEntries(), r = n.find((e) => e.index === t) || n[0], i = r?.index ?? t, a = this._deckCards.filter((e) => e !== r), o = bd(this._config), s = xd(this._config);
			return w`
      <ha-card
    ...
    ` : "";
      ...
      <ha-card class="deck-card overlay">
        <div class="deck-overlay">
          ...
          ${t.map((e, t) => w`
            <div
              class="deck-overlay-item deck-item ${vd(e.item)} ${e.item?.attributes?.transparent_background === !0 ? "transparent-background" : ""} overlay-${e.kind || ld(e.item)}"
              data-deck-index=${e.index}
              style=${hd(e.item, t)}
            >
...
function mf({ tag: e, badgeClass: t, name: n, description: r, version: a, documentationURL: o }) {
	...
	window.customBadges.push({
		...
		description: r,
		preview: !0,
		documentationURL: o || Et(e)
	}), i(n, a);
}
//#endregion
//#region src/badges/helpers/model.js
function hf() {
	let e = Z(this._config), t = this._getEntities(), n = xc(t), r = e === "template" ? I.call(this, this._config?.state_template, "") ?? "unavailable" : "", i = this._config?.active_template?.trim() || "", a = e === "template" && i ? I.call(this, i, "") : null, o = this._config?.inactive_template?.trim() || "", s = e === "template" && o ? I.call(this, o, "") : null, c = !!o && Lt(s), l = e === "template" ? Lt(a ?? r) : n.length > 0, u = this._config?.display_style === "badge" && !this._config?.card_visibility ? !0 : l, d = t[0], f = oc(this._config), p = f[0] || "", m = d?.entity_id.split(".")[0] || this._config?.domain || "", ee = $s(m), te = this._config?.icon_source || (this._config?.icon ? "custom" : "domain"), ne = this._config?.icon || "", re = u ? this._config?.icon_on || ne : this._config?.icon_off || ne, ie = te === "custom" && re || ee.icon, h = u ? this._config?.accent_on_color ?? this._config?.color : this._config?.accent_off_color, g = !!(h && ![
		"theme",
		"state",
		"state-active",
		"state-inactive"
		...
		"state-active",
		"state-inactive"
	].includes(h) ? "theme" : h, oe = e === "template" && this._config?.name_template?.trim() || "", _ = oe ? I.call(this, oe, "") : null, v = String(_ ?? "").trim(), y = e === "template" && !d ? {
		...
		state: y.state,
		attributes: p ? { device_class: p } : {}
	}, b = fc(this.hass, this._config), ce = this._config?.name, le = f.map((e) => ac(e)).join(", "), ue = (d && this.hass?.formatEntityName ? this.hass.formatEntityName(d) : "") || (e === "template" ? "Template" : b || le || ee.label), de = ce && this.hass?.formatEntityName && this.hass.formatEntityName(y, gf(ce, v)) || ue, fe = te === "custom" ? u && this._config?.icon_on ? "icon_on" : !u && this._config?.icon_off ? "icon_off" : this._config?.icon ? "icon" : "" : "";
	return {
		entities: t,
		activeEntities: n,
		isOn: u,
		...
		iconColor: ae === "theme" ? mc(y, u) : P(ae)
	};
}
function gf(e, t) {
...
`, vf = "sensor.orbit_status_badge_preview", yf = class extends k {
	static svgCache = R;
	static properties = {
		hass: { attribute: !1 },
		_config: { state: !0 },
	...
	connectedCallback() {
		super.connectedCallback(), fo(this), Dt(this, "orbit-status-badge-dev"), queueMicrotask(() => this._syncTemplateSubscriptions());
	}
	disconnectedCallback() {
		this._namePickerEnhanceFrame !== void 0 && (cancelAnimationFrame(this._namePickerEnhanceFrame), this._namePickerEnhanceFrame = void 0), Ft.call(this), po(this), super.disconnectedCallback();
	}
	updated(e) {
	...
	_updateConfig(e) {
		this._config = ic(xi(this._config, e)), this._dispatchConfigChanged(this._config);
	}
		...
		return {
			...
			entities: {
				...
				[vf]: {
					entity_id: vf,
					platform: "orbit",
					area_id: dc(this._config)[0] || null,
					device_id: null
				}
			},
			states: {
	...
	render() {
		let e = this._config?.display_style === "badge", n = this._getDeviceClassOptions(), r = Js.find((e) => e.value === this._config?.domain), i = [
			...this._config?.show_name === !0 ? ["name"] : [],
			...this._config?.show_state === !1 ? [] : ["state"],
			...this._config?.show_icon === !1 ? [] : ["icon"]
		], a = Z(this._config), o = this._config?.entity || "", s = a === "entity" && o ? this.hass : this._getStateContentHass(), c = a === "entity" && o ? o : vf;
		return w`
      <div class="wrapper">
        <div class="section">
...
mf({
	...
	badgeClass: class extends k {
		...
		disconnectedCallback() {
			Ft.call(this), wc.call(this), this._clearDoubleTapTimer(), this._cancelLongPress(), super.disconnectedCallback();
		}
		updated(e) {
		...
		shouldUpdate(e) {
			...
			return r === "template" ? !0 : (r === "area_count" ? pc(this.hass, this._config) : [this._config?.entity].filter(Boolean)).some((e) => t.states?.[e] !== n.states?.[e]);
		}
		_syncTemplateSubscriptions() {
		...
		_handlePointerDown(e, t) {
			if (A(this._config?.hold_action)) return On.call(this, e, t, this._config?.hold_action);
		}
		_handlePointerEnd(e) {
			return An.call(this, e);
		}
      ...
      `;
			if (bn(e.icon)) {
				let t = xn(e.icon), r = e.iconKey ? Sn(this._config, e.iconKey) : !0;
