...
function sn(e = {}) {
	let t = { ...e || {} }, n = !1;
	return t.type === "custom:orbit-room-card" && (t.type = "custom:orbit-area-card", n = !0), Object.prototype.hasOwnProperty.call(t, "room_name") && (t.area_name === void 0 && t.room_name !== void 0 && t.room_name !== "" && (t.area_name = t.room_name), delete t.room_name, n = !0), n = Cn(t) || n, n = hn(t) || n, {
		config: n ? t : e,
		migrated: n
	};
}
...
function dn(e) {
	return fn(e, "orbit-status-card") ? pn(e) : fn(e, "orbit-area-card") || fn(e, "orbit-room-card") ? sn(e) : fn(e, "orbit-action-card") ? cn(e) : fn(e, "orbit-deck-card") ? un(e) : {
		config: e,
		migrated: !1
	};
}
...
`
	...
	_updateDocumentationContext() {
		rn(this, this._config?.type || "orbit-area-card", this._activeSection || "card");
	}
...
customElements.get("orbit-area-card-editor") || customElements.define("orbit-area-card-editor", Zs), customElements.get("orbit-room-card-editor") || customElements.define("orbit-room-card-editor", $s);
var ec = [
	"state_template",
	"icon_source",
	"icon",
...
function Sc(e = {}) {
	...
	if (t === "area_count" && n?.requiresDeviceClass && Q(e).length === 0) throw Error(`Orbit Status Badge requires "device_class" for domain "${e.domain}".`);
	return t;
}
function Cc(e = {}) {
...
`, ad = Symbol.for("orbit-status-card-preview-selected-index"), od = class extends A {
	static svgCache = B;
	static properties = {
		hass: { attribute: !1 },
		_config: { state: !0 },
	...
	connectedCallback() {
		super.connectedCallback(), Go(this), rn(this, "orbit-status-card");
	}
	disconnectedCallback() {
		Ko(this), super.disconnectedCallback();
	}
...
customElements.get("orbit-status-card-editor") || customElements.define("orbit-status-card-editor", od);
function sd(e) {
...
`, mf = class extends A {
	...
	connectedCallback() {
		super.connectedCallback(), Go(this), rn(this, "orbit-action-card");
	}
	disconnectedCallback() {
		Ko(this), super.disconnectedCallback();
	}
...
customElements.get("orbit-action-card-editor") || customElements.define("orbit-action-card-editor", mf);
function hf(e) {
...
var Rp = [
  ...
  `
], zp = Symbol.for("orbit-deck-card-preview-selected-index"), Bp = class extends A {
	static properties = {
		hass: { attribute: !1 },
...
`, Jp = "sensor.orbit_status_badge_preview", Yp = class extends A {
	...
	connectedCallback() {
		super.connectedCallback(), Go(this), rn(this, "orbit-status-badge"), queueMicrotask(() => this._syncTemplateSubscriptions());
	}
	disconnectedCallback() {
