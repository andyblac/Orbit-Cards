...
function rn(e = {}) {
	let t = { ...e || {} }, n = !1;
	return t.type === "custom:orbit-room-card" && (t.type = "custom:orbit-area-card", n = !0), Object.prototype.hasOwnProperty.call(t, "room_name") && (t.area_name === void 0 && t.room_name !== void 0 && t.room_name !== "" && (t.area_name = t.room_name), delete t.room_name, n = !0), n = fn(t) || n, {
		config: n ? t : e,
		migrated: n
	};
}
...
function on(e) {
	return sn(e, "orbit-status-card") ? cn(e) : sn(e, "orbit-deck-card") ? an(e) : {
		config: e,
		migrated: !1
	};
}
...
`, eu = Symbol.for("orbit-status-card-preview-selected-index"), tu = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), lo(this), en(this, "orbit-status-card");
	}
	disconnectedCallback() {
		uo(this), super.disconnectedCallback();
	}
...
`, ed = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), lo(this), en(this, "orbit-action-card");
	}
	disconnectedCallback() {
		uo(this), super.disconnectedCallback();
	}
...
`, Ff = "sensor.orbit_status_badge_preview", If = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), lo(this), en(this, "orbit-status-badge"), queueMicrotask(() => this._syncTemplateSubscriptions());
	}
	disconnectedCallback() {
