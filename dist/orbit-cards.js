...
})), f, p, m, h, g, _, v, y, b, ee, x, te, S, ne, C, re = e((() => {
	d(), {is: f, defineProperty: p, getOwnPropertyDescriptor: m, getOwnPropertyNames: h, getOwnPropertySymbols: g, getPrototypeOf: _} = Object, v = globalThis, y = v.trustedTypes, b = y ? y.emptyScript : "", ee = v.reactiveElementPolyfillSupport, x = (e, t) => e, te = {
		toAttribute(e, t) {
			switch (t) {
				case Boolean:
					e = e ? b : null;
		...
		useDefault: !1,
		hasChanged: S
	}, Symbol.metadata ??= Symbol("metadata"), v.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap(), C = class extends HTMLElement {
...
var ae, oe, T, se, E, D, ce, le, ue, de, fe, pe, me, he, ge, _e, ve, ye, be, xe, Se, Ce, O, k, A, we, j, Te, Ee, De, Oe, ke, Ae, je, Me, Ne, Pe, Fe, Ie, Le = e((() => {
	ae = globalThis, oe = (e) => e, T = ae.trustedTypes, se = T ? T.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, E = "$lit$", D = `lit$${Math.random().toFixed(9).slice(2)}$`, ce = "?" + D, le = `<${ce}>`, ue = document, de = () => ue.createComment(""), fe = (e) => e === null || typeof e != "object" && typeof e != "function", pe = Array.isArray, me = (e) => pe(e) || typeof e?.[Symbol.iterator] == "function", he = "[ 	\n\f\r]", ge = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _e = /-->/g, ve = />/g, ye = RegExp(`>|${he}(?:([^\\s"'>=/]+)(${he}*=${he}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), be = /'/g, xe = /"/g, Se = /^(?:script|style|textarea|title)$/i, Ce = (e) => (t, ...n) => ({
		_$litType$: e,
		strings: t,
		values: n
	}), O = Ce(1), Ce(2), Ce(3), k = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), j = ue.createTreeWalker(ue, 129), Te = (e, t) => {
		...
		for (let t = 0; t < n; t++) {
			...
			a += o === ge ? n + le : l >= 0 ? (r.push(s), n.slice(0, l) + E + n.slice(l) + D + d) : n + D + (l === -2 ? t : d);
		}
				...
				if (i.nodeType === 1) {
					...
					if (Se.test(i.tagName)) {
						...
						if (t > 0) {
							...
							for (let n = 0; n < t; n++) i.append(e[n], de()), j.nextNode(), c.push({
								type: 2,
								index: ++a
							});
							i.append(e[t], de());
		...
		_$AI(e, t = this) {
			e = w(this, e, t), fe(e) ? e === A || e == null || e === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : e !== this._$AH && e !== k && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? me(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
		}
		O(e) {
		...
		_(e) {
			this._$AH !== A && fe(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ue.createTextNode(e)), this._$AH = e;
		}
		$(e) {
			let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = Ee.createElement(ie(n.h, n.h[0]), this.options)), n);
		...
		_$AI(e, t = this, n, r) {
			...
			if (i === void 0) e = w(this, e, t, 0), a = !fe(e) || e !== this._$AH && e !== k, a && (this._$AH = e);
			else {
				let r = e, o, s;
				for (e = i[0], o = 0; o < i.length - 1; o++) s = w(this, r[n + o], t, o), s === k && (s = this._$AH[o]), a ||= !fe(s) || s !== this._$AH[o], s === A ? e = A : e !== A && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
			}
			a && !r && this.j(e);
		}
		j(e) {
		...
		B: Ae,
		F: Ne
	}, Fe = ae.litHtmlPolyfillSupport, Fe?.(Ee, Oe), (ae.litHtmlVersions ??= []).push("3.3.3"), Ie = (e, t, n) => {
		let r = n?.renderBefore ?? t, i = r._$litPart$;
		if (i === void 0) {
			let e = n?.renderBefore ?? null;
			r._$litPart$ = i = new Oe(t.insertBefore(de(), e), e, void 0, n ?? {});
		}
		return i._$AI(e), i;
	};
})), Re, M, ze, Be = e((() => {
	re(), re(), Le(), Le(), Re = globalThis, M = class extends C {
		constructor() {
...
function I(e, t, n, r) {
	if (!F(this)) {
		if (We(e), this._clearDoubleTapTimer?.(), P(r)) {
...
function L(e, t, n) {
	F(this) || (We(e), this._clearDoubleTapTimer?.(), P(n) && this._handleAction(n, t));
}
function Ue() {
...
function Ye(e) {
	L.call(this, e, e.currentTarget.dataEntity, e.currentTarget.dataDoubleAction);
}
function Xe(e) {
...
function Qe(e) {
	if (!F(this)) {
		...
		I.call(this, e, this._config.main_entity || this._config.entity, nt(this._config), this._config.double_tap_action);
	}
}
function $e(e) {
	if (!F(this)) {
		if (e.composedPath().some((e) => e?.classList && e.classList.contains("circle"))) return tt.call(this, e);
		L.call(this, e, this._config.main_entity || this._config.entity, this._config.double_tap_action);
	}
}
function et(e) {
	if (this._longPressTriggered) {
	...
	if (!t) {
		I.call(this, e, null, nt(this._config), this._config.double_tap_action);
		return;
	}
	I.call(this, e, t, rt(this._config), this._config.main_entity_double_tap_action);
}
function tt(e) {
	let t = this._config.main_entity || this._config.entity;
	if (!t) {
		L.call(this, e, null, this._config.double_tap_action);
		return;
	}
	L.call(this, e, t, this._config.main_entity_double_tap_action);
}
function nt(e = {}) {
...
function ht(e, t) {
	...
	return `color-mix(in srgb, transparent, ${gt(n) ? n : lt(n)} ${t}%)`;
}
function gt(e) {
	let t = e.toString().trim();
...
var jt, Mt, Nt = e((() => {
	jt = "https://github.com/andyblac/Orbit-Cards/wiki", Mt = {
		"orbit-area-card": {
			default: "Area-Card",
...
function Pt({ tag: e, cardClass: t, name: n, description: r, version: i, getEntitySuggestion: a, documentationURL: o, aliases: s = [] }) {
...
function Tr(e, t, n, r) {
	return n ? br.call(this, e, t, !0) : r.startsWith("rgba(") ? r : ht(r, 40);
}
function Er(e = {}, t, n) {
...
var Dr = e((() => {
	...
	Le(), jr(), Mr = class extends Ar {
		constructor(e) {
			if (super(e), this.it = A, e.type !== Or.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
		}
		render(e) {
...
var Br = e((() => {
	...
	Le(), {I: Vr} = Pe, Hr = (e) => e, Ur = () => document.createComment(""), Wr = (e, t, n) => {
...
function ba(e, t) {
	return Ca(e?.hass, t) || ts[t] || t;
}
function xa(e, t) {
	return wa(e?.hass, t) || t;
}
function Sa(e) {
	e.stopPropagation();
}
...
function Ta(e, t, n) {
	...
	return Ea.call(this, e, t, r, (e) => this._handleConfigUpdate(t, e), n);
}
function Ea(e, t, n, r, i) {
	Ia.call(this);
	let a = Da.call(this, n, i), o = to(n || a), s = this._colorPickerKey === t && this._colorPickerTab || o;
	return O`
    <div class="field">
      <div class="color-row">
        <div
...
function Oa(e, t, n, r = t) {
	let i = no(t) ? this._getColorPickerValue(t) : "", a = i || (no(t) ? this._getColorPickerValue(t) : this._getColorPickerValue(t || r)) || "#000000";
	return O`
    <div
...
function ka(e, t, n, r = t) {
	let i = t || r, a = to(i) === "theme" ? Ba(i) || "theme" : "", o = Fa.call(this);
	return O`
    <div
    ...
    >
      <ha-generic-picker
        ...
        .value=${a}
        .getItems=${() => o}
        .rowRenderer=${(e) => Aa.call(this, e)}
        .valueRenderer=${(e) => ja.call(this, o.find((t) => t.id === e))}
...
function Pa() {
	...
	for (let n of is) {
		let r = Ra.call(this, n);
		!r || t.has(r.id) || (t.add(r.id), e.push(r));
	}
	for (let n of Va.call(this)) {
		let r = Ra.call(this, n);
		!r || t.has(r.id) || (t.add(r.id), e.push(r));
	}
	return e;
...
function Ia() {
	...
	let t = () => {
		this._themeColorWarmupScheduled === e && (Fa.call(this), this._themeColorWarmupScheduled = "");
	};
...
function La() {
	return `${this?.hass?.locale?.language || this?.hass?.language || ""}|${this?.hass?.selectedTheme?.theme || this?.hass?.themes?.theme || ""}|${this?.hass?.themes?.darkMode ?? this?.hass?.selectedTheme?.dark ?? ""}|${Ha.call(this)}`;
}
function Ra(e) {
	let t = za(typeof e == "string" ? { id: e } : e), n = Qa(t.id), r = n && $a(t.id), i = !r && (t.source === "theme" || Xa.call(this, t.id)), a = t.label ? q(this, t.label) : eo.call(this, t.id);
	return {
		id: t.id,
		primary: a,
...
function Va() {
	return Ua.call(this).map((e) => Ka(e)).filter(qa).map((e) => ({
		id: e,
		source: "theme"
	})).sort((e, t) => eo.call(this, e.id).localeCompare(eo.call(this, t.id), this?.hass?.locale?.language || this?.hass?.language || void 0, { sensitivity: "base" }));
}
function Ha() {
	return Wa.call(this).map(([e, t]) => `${e}:${t}`).join(",");
}
function Ua() {
	return Wa.call(this).map(([e]) => e).sort();
}
function Wa() {
	let e = /* @__PURE__ */ new Set(), t = [], n = Ga.call(this);
	for (let [r, i] of Object.entries(n)) {
		let n = r.toLowerCase();
		Ja(n, i) && (e.has(n) || (e.add(n), t.push([n, i])));
	}
...
function Xa(e) {
	let t = new Set(Ua.call(this));
	return Za(e).some((e) => t.has(e));
}
function Za(e) {
	let t = Ba(e);
	if (!t) return [];
...
function to(e) {
	let t = e?.toString().trim();
	return t && no(t) ? "picker" : "theme";
}
function no(e) {
	let t = e?.toString().trim().toLowerCase();
	return !!(t && (t.startsWith("#") || t.startsWith("rgb") || t.startsWith("hsl")));
}
function ro(e, t, n, { extraActions: r = [] } = {}) {
	let i = this._config?.[t], a = typeof n == "object" ? n : { action: n || "none" }, o = i && typeof i == "object" ? Do(i, a) : a, s = o.action || a.action || "none", c = new Set(r.map((e) => e.id)), l = [...r, ...vo(this).filter((e) => !c.has(e.id))];
	return O`
    <div class="field action-field">
      <div class="action-picker">
        <ha-generic-picker
          ...
          .getItems=${() => l}
          .rowRenderer=${(e) => yo(e)}
          .valueRenderer=${(e) => bo(l.find((t) => t.id === e))}
          .notFoundLabel=${q(this, "No matching actions")}
          .noSort=${!0}
          @value-changed=${(e) => {
		e.stopPropagation();
		let n = _o(e) || "none";
		this._updateConfig({ [t]: Eo(this, n, o) }), this.requestUpdate?.();
	}}
        ></ha-generic-picker>
      </div>

      ${s === "navigate" ? So.call(this, t, o) : ""}

      ${s === "call-service" ? Co.call(this, t, o) : ""}

      ${s === "url" ? wo.call(this, t, o) : ""}

      ${s === "popup" ? To.call(this, t, o) : ""}
    </div>
  `;
}
function io({ interactions: e = [], title: t = "Interactions", expanded: n = !1, context: r = {}, config: i = this._config, onChange: a } = {}) {
	let o = e.filter(Boolean);
	if (!o.length) return "";
	let s = o.filter((e) => ao(i, e)), c = o.filter((e) => !s.includes(e)), l = [{
		name: "interactions",
		type: "expandable",
		flatten: !0,
		expanded: n,
		icon: "mdi:gesture-tap-button",
		schema: [...s.map((e) => oo(e, r)), {
			name: "",
			type: "optional_actions",
			flatten: !0,
			schema: c.map((e) => oo(e, r))
		}]
	}], u = so(i, o);
	return O`
    <ha-form
      ...
      .data=${u}
      .schema=${l}
      .computeLabel=${(e) => lo(this, e, o, t)}
      @value-changed=${(e) => {
		e.stopPropagation();
		let t = co(e.detail.value || {}, o, i);
...
function ao(e = {}, t) {
	return t.defaultVisible && !fo(e?.[t.key]);
}
function oo(e, t) {
	let n = uo(e.defaultAction);
	return {
...
function so(e = {}, t) {
	return t.reduce((t, n) => {
		let r = n.formKey || n.key, i = e?.[n.key] || (n.displayDefaultValue ? mo(n.defaultAction) : void 0);
		return i && typeof i == "object" && i.action !== "popup" && (!fo(i) || uo(n.defaultAction) !== "none") && (t[r] = ho(i)), t;
	}, {});
}
function co(e, t, n = {}) {
	return t.reduce((t, r) => {
		let i = r.formKey || r.key, a = go(e[i], r.defaultAction);
...
function go(e, t) {
	if (!(!e || typeof e != "object") && !(e.action === "none" && uo(t) === "none")) {
...
function vo(e) {
	return [
		...
		{
			id: "more-info",
			primary: ba(e, "more-info"),
			icon: "mdi:information-outline"
		},
		{
			id: "navigate",
			primary: ba(e, "navigate"),
			icon: "mdi:arrow-right"
		},
		{
			id: "call-service",
			primary: ba(e, "perform-action"),
			icon: "mdi:flash"
		},
		{
			id: "url",
...
function Eo(e, t, n) {
	...
	return t === "popup" ? J({
		...r,
		popup_title: r.popup_title || q(e, "Security"),
...
function qo() {
	return Object.values(this.hass?.areas || {}).map((e) => Jo.call(this, e)).sort(Qo);
}
function Jo(e) {
	let t = e.name || e.area_id, n = Zo(this.hass, e);
	return {
		id: e.area_id,
		primary: t,
		secondary: n,
...
function ss(e) {
	e._editorPopoverCloseHandler || (e._editorPopoverCloseHandler = (t) => {
		!e._iconPickerKey && !e._colorPickerKey || ls(t.composedPath?.() || []) || (e._iconPickerKey = "", e._colorPickerKey = "", e._iconFilePickerOpen = !1, e._iconFileSearch = "", e._themeColorPickerOpen = !1, e._themeColorSearch = "", e.requestUpdate?.());
...
function ds(e) {
	let t = e?.toString().trim();
	return t && (hs(t) || gs(t) || fs(t)) || "#ffffff";
}
function fs(e, t = /* @__PURE__ */ new Set()) {
	let n = e?.toString().trim().toLowerCase().replace(/[^a-z0-9-_]/g, "");
	if (!n || t.has(n)) return "";
	t.add(n);
	let r = ft(n), i = dt(n) ? ms(r) : "", a = ut(n) ? ms(`${n}-color`) : "", o = ms(n), s = n.startsWith("color-") ? "" : ms(`color-${n}`);
	return ps(i, t) || ps(a, t) || ps(o, t) || ps(s, t) || "";
}
function ps(e, t) {
	let n = e?.trim();
	if (!n) return "";
...
function gs(e) {
	...
	if (t) return _s(Number(t[1]), Number(t[2]), Number(t[3]));
	let n = e.match(/^\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*$/i);
	return n ? _s(Number(n[1]), Number(n[2]), Number(n[3])) : "";
}
function _s(e, t, n) {
...
function bs({ label: e = "Name", valueKey: t, legacyValueKey: n = "", entityKey: r = "main_entity", areaKey: i = "area", defaultType: a = "", modeKey: o = t } = {}) {
	return xs.call(this), customElements.get("ha-entity-name-picker") ? O`
    <div class="field name-picker-field">
      <ha-entity-name-picker
        .hass=${this.hass}
        .label=${this._t(e)}
        .entityId=${Vs.call(this, {
		entityKey: r,
		areaKey: i
	})}
        .value=${Ps(this._config, {
		valueKey: t,
		legacyValueKey: n,
		entityKey: r,
		areaKey: i,
        ...
        @value-changed=${(e) => {
		e.stopPropagation(), Ls.call(this, {
			valueKey: t,
			legacyValueKey: n,
			value: Rs(e.detail.value, this._config, {
				entityKey: r,
				areaKey: i,
				defaultType: a
			})
...
function Ss(e) {
	let t = Ds(this._config, Os(this, e.modeKey), e);
	return O`
    <div class="field name-picker-field name-picker-fallback">
      <div class="field-header">
		...
		label: Gs(this, "composed"),
		value: "composed"
	}, {
		label: Gs(this, "custom"),
		value: "custom"
	}] } }}
          .value=${t}
          @value-changed=${(t) => {
		...
		if (ks(this, e.modeKey, n), n === "composed") {
			Ls.call(this, {
				valueKey: e.valueKey,
		...
		if (typeof Is(this._config, e) != "string") {
			Ls.call(this, {
				valueKey: e.valueKey,
				legacyValueKey: e.legacyValueKey,
				value: void 0
      ...
      ${t === "custom" ? Cs.call(this, e) : ws.call(this, e)}
    </div>
  `;
}
function Cs(e) {
    ...
    <ha-selector
      ...
      .hass=${this.hass}
      .selector=${{ text: {} }}
      .value=${typeof Is(this._config, e) == "string" ? Is(this._config, e) : ""}
      @value-changed=${(t) => {
		t.stopPropagation(), Ls.call(this, {
			valueKey: e.valueKey,
			legacyValueKey: e.legacyValueKey,
...
function ws(e) {
	let t = As(this._config, e), n = Ms.call(this, t, e);
	return O`
    <ha-generic-picker
      ...
      @value-changed=${(n) => {
		n.stopPropagation();
		let r = Ns(n.detail.value);
		r && (ks(this, e.modeKey, "composed"), Ls.call(this, {
			valueKey: e.valueKey,
			legacyValueKey: e.legacyValueKey,
			value: Rs([...t, r], this._config, e)
		}));
	}}
    >
      <div slot="field" class="name-picker-composed-field">
        ${t.map((n, r) => Ts.call(this, n, r, t, e))}
...
function js(e) {
	return e ? e.type === "text" ? `"${e.text || ""}"` : e.type === "area" ? this._t("Area") : e.type === "entity" ? this._t("Entity") : Ys(this, e.type) : "";
}
function Ms(e = [], t) {
	let n = [], r = new Set(e.filter((e) => e?.type && e.type !== "text").map((e) => e.type)), i = t.areaKey && this._config?.[t.areaKey] ? this.hass?.areas?.[this._config[t.areaKey]] : null, a = Vs.call(this, t), o = a ? this.hass?.states?.[a] : null;
	...
	if (o) {
		r.has("entity") || n.push({
			...
			secondary: Us(this.hass, o, "entity")
		});
		let e = Us(this.hass, o, "device");
		e && !r.has("device") && n.push({
			id: "device",
			primary: Ys(this, "device"),
			secondary: e
		});
		let i = Ws(this.hass, this._config?.[t.areaKey]) || Us(this.hass, o, "floor");
		i && !r.has("floor") && n.push({
			id: "floor",
			primary: Ys(this, "floor"),
			secondary: i
		});
	}
	return n;
...
function Ls({ valueKey: e, legacyValueKey: t, value: n }) {
...
function Rs(e, t = {}, n) {
	if (!(!e || Array.isArray(e) && e.length === 0) && !(n.defaultType && zs(t, n) && Bs(e, n.defaultType))) return e;
}
function zs(e = {}, t) {
...
function Vs(e) {
	return this._config?.[e.entityKey] || this._config?.entity || Hs(this.hass, this._config?.[e.areaKey]);
}
function Hs(e, t) {
	if (!e || !t) return "";
...
function sc() {
    ...
    <div class="section">
      ...
      ${uc.call(this, `curve_button${e}`, "", "more-info", { index: e }, {
		showColors: !0,
		filteredEntity: !0,
...
function uc(e, t, n, r = {}, i = {}) {
    ...
    <div class="sub-section selected-button-section">
      ...
      ${i.filteredEntity ? dc.call(this, "Entity", e, i) : this._renderEntity("Entity", e)}

      ${i.showColors ? O`
            <div class="color-pair">
              ${fc.call(this, ["Active", "Color"], `${e}_on_color`)}
              ${fc.call(this, ["Inactive", "Color"], `${e}_off_color`)}
            </div>
          ` : ""}
...
function dc(e, t, n = {}) {
	let r = this[n.filterKey || "_areaActionButtonDomainFilter"] || "all", i = n.filters || pc;
	return O`
    <div class="field">
...
})), Ic, Lc, Rc, zc, Bc, Vc, Hc, Uc, Wc, Gc, Kc, qc, Jc, Yc, Xc, Zc, Qc, $c, el, tl, nl, rl, il = e((() => {
	Ic = "Always", Lc = "Badge", Rc = "Content", zc = "Domain", Bc = "Hide", Vc = "Header", Hc = "Labels", Uc = "State", Wc = "Template", Gc = "Type", Kc = "Visibility", qc = "Cards", Jc = "Dynamic", Yc = "Files", Xc = "Separator", Zc = "Main", Qc = "Overlay", $c = "Crop", el = "Resize", tl = "Height", nl = "Tabs", rl = {
		"Active entities": "Active entities",
...
})), al, ol, sl, cl, ll, ul, dl, fl, pl, ml, hl, gl, _l, vl, yl, bl, xl, Sl, Cl, wl, Tl, El, Dl = e((() => {
	al = "Always", ol = "Badge", sl = "Content", cl = "Domain", ll = "Hide", ul = "Header", dl = "Labels", fl = "State", pl = "Template", ml = "Type", hl = "Visibility", gl = "Cards", _l = "Dynamic", vl = "Files", yl = "Separator", bl = "Main", xl = "Overlay", Sl = "Crop", Cl = "Resize", wl = "Height", Tl = "Tabs", El = {
		"Active entities": "Active entities",
		"No active entities": "No active entities",
		Always: al,
		"Area Count": "Area Count",
...
})), Ol, kl, Al, jl, Ml, Nl, Pl, Fl, Il, Ll, Rl, zl, Bl, Vl, Hl, Ul, Wl, Gl, Kl, ql, Jl, Yl = e((() => {
	Ol = "Immer", kl = "Abzeichen", Al = "Inhalt", jl = "Domäne", Ml = "Ausblenden", Nl = "Kopfzeile", Pl = "Bezeichnungen", Fl = "Zustand", Il = "Vorlage", Ll = "Sichtbarkeit", Rl = "Karten", zl = "Dynamisch", Bl = "Dateien", Vl = "Trennzeichen", Hl = "Hauptkarte", Ul = "Überlagerung", Wl = "Zuschneiden", Gl = "Größe ändern", Kl = "Höhe", ql = "Tabs", Jl = {
...
})), Xl, Zl, Ql, $l, eu, tu, nu, ru, iu, au, ou, su, cu, lu, uu, du, fu, pu, mu, hu, gu, _u, vu = e((() => {
	Xl = "Siempre", Zl = "Insignia", Ql = "Contenido", $l = "Dominio", eu = "Ocultar", tu = "Encabezado", nu = "Etiquetas", ru = "Estado", iu = "Plantilla", au = "Tipo", ou = "Visibilidad", su = "Tarjetas", cu = "Dinámico", lu = "Archivos", uu = "Separador", du = "Principal", fu = "Superposición", pu = "Recortar", mu = "Redimensionar", hu = "Alto", gu = "Pestañas", _u = {
...
})), yu, bu, xu, Su, Cu, wu, Tu, Eu, Du, Ou, ku, Au, ju, Mu, Nu, Pu, Fu, Iu, Lu, Ru, zu, Bu, Vu = e((() => {
	yu = "Toujours", bu = "Badge", xu = "Contenu", Su = "Domaine", Cu = "Masquer", wu = "En-tête", Tu = "Étiquettes", Eu = "État", Du = "Modèle", Ou = "Type", ku = "Visibilité", Au = "Cartes", ju = "Dynamique", Mu = "Fichiers", Nu = "Séparateur", Pu = "Principal", Fu = "Superposition", Iu = "Recadrer", Lu = "Redimensionner", Ru = "Hauteur", zu = "Onglets", Bu = {
...
})), Hu, Uu, Wu, Gu, Ku, qu, Ju, Yu, Xu, Zu, Qu, $u, ed, td, nd, rd, id, ad, od, sd, cd, ld, ud = e((() => {
	Hu = "Sempre", Uu = "Badge", Wu = "Contenuto", Gu = "Dominio", Ku = "Nascondi", qu = "Intestazione", Ju = "Etichette", Yu = "Stato", Xu = "Modello", Zu = "Tipo", Qu = "Visibilità", $u = "Schede", ed = "Dinamico", td = "File", nd = "Separatore", rd = "Principale", id = "Sovrapposizione", ad = "Ritaglia", od = "Ridimensiona", sd = "Altezza", cd = "Schede", ld = {
...
})), dd, fd, pd, md, hd, gd, _d, vd, yd, bd, xd, Sd, Cd, wd, Td, Ed, Dd, Od, kd, Ad, jd, Md, Nd = e((() => {
	dd = "Altijd", fd = "Badge", pd = "Inhoud", md = "Domein", hd = "Verbergen", gd = "Koptekst", _d = "Labels", vd = "Status", yd = "Sjabloon", bd = "Type", xd = "Zichtbaarheid", Sd = "Kaarten", Cd = "Dynamisch", wd = "Bestanden", Td = "Scheidingsteken", Ed = "Hoofdkaart", Dd = "Overlay", Od = "Bijsnijden", kd = "Formaat wijzigen", Ad = "Hoogte", jd = "Tabbladen", Md = {
...
})), Pd, Fd, Id, Ld, Rd, zd, Bd, Vd, Hd, Ud, Wd, Gd, Kd, qd, Jd, Yd, Xd, Zd, Qd, $d, ef, tf, nf = e((() => {
	Pd = "Sempre", Fd = "Emblema", Id = "Conteúdo", Ld = "Domínio", Rd = "Ocultar", zd = "Cabeçalho", Bd = "Rótulos", Vd = "Estado", Hd = "Modelo", Ud = "Tipo", Wd = "Visibilidade", Gd = "Cartões", Kd = "Dinâmico", qd = "Arquivos", Jd = "Separador", Yd = "Principal", Xd = "Sobreposição", Zd = "Recortar", Qd = "Redimensionar", $d = "Altura", ef = "Abas", tf = {
...
function Y(e, t, n = {}) {
	let r = of(e), i = r.replace("_", "-"), a = r.split("-")[0], o = rf(e, t) || af(r, t) || af(i, t) || af(a, t) || sf.en[t] || t;
...
var sf, cf, lf = e((() => {
	...
	N(), ys(), tc(), oc(), hc(), oa(), Fc(), H(), tn(), Nt(), lf(), Z();
	var e = class extends M {
		...
		connectedCallback() {
			super.connectedCallback(), ss(this), this._updateDocumentationContext();
		}
		disconnectedCallback() {
			cs(this), super.disconnectedCallback();
		}
		_getColorStyle(e) {
			return us(e);
		}
		...
		_handleEntityUpdate(e, t) {
			...
			this._updateConfig(ha("main_entity", r));
		}
    ...
    `;
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Area Card v{version}", { version: X.area })}
        </div>
      </div>
    `;
		}
	...
	N(), it(), R(), Et(), Ft(), tn(), an(), Wn(), Jn(), Zt(), Qn(), nr(), H(), Dr(), Ir(), Br(), ni(), Oi(), uf(), Z();
	var e = class extends M {
		static svgCache = V;
		...
		willUpdate(e) {
			return (e.has("_config") || e.has("hass")) && Rt.call(this, this._getTemplateEntries()), sr.call(this, e);
		}
		disconnectedCallback() {
			zt.call(this), super.disconnectedCallback();
		}
		shouldUpdate(e) {
		...
		_handleMainEntityPointerDown(e) {
			if (!F(this)) return this._startLongPress(e, this._config.main_entity || this._config.entity, this._config.main_entity_hold_action);
		}
...
function ff({ config: e = {}, count: t = 1, wrapKey: n = "wrap", perRowKey: r, defaultColumns: i = 3 }) {
...
function xf(e) {
	...
	let r = Object.values(t).filter((e) => e.entity_id?.startsWith("zone.") && !e.attributes?.passive), i = {
		zones: r,
		zoneByTrackerState: new Map(r.map((e) => [Sf(e), e]))
	};
	return Cf.set(t, i), i;
}
function Sf(e) {
...
function Tf(e) {
	...
	if (this._config.mode === "icon_only") {
		...
		this._statusItems = e.map((e) => Df.call(this, e, this._config)), kf.call(this, this._statusItems[0] || {});
		return;
	}
	let t = this._config.main_entity, n = Df.call(this, { entity: t }, this._config);
	this._statusItems = [n], kf.call(this, n);
}
function Ef(e = {}) {
...
function Df(e, t = {}) {
	let n = e.entity || t.main_entity, r = n && this.hass ? this.hass.states[n] : null, i = {
		...
		...e,
		main_entity: n
	}, a = i.mode !== "icon_only" && Object.prototype.hasOwnProperty.call(i, "status_name") && i.status_name !== void 0 && i.status_name !== "" ? xt(i.status_name, i, this.hass) : Q(r, "friendly_name") || n || Y(this.hass, "Status"), o = i.state_template ? this._evaluateStateTemplate(i.state_template, n) : null, s = (i.label_template ? this._evaluateStateTemplate(i.label_template, n) : null) ?? (Q(r, "label") || (r ? this.formatState(r) : "")), c = i.main_entity_icon, l = i.main_entity_icon_on, u = i.main_entity_icon_off, d = _f(r, (e) => this._getEntityActiveState(e), o), f = Of(i, n), p = f === "custom" && ((d ? l : u) || c) || "", m = p || "mdi:information-outline", h = f === "custom" && d && l ? "main_entity_icon_on" : f === "custom" && !d && u ? "main_entity_icon_off" : f === "custom" && c ? "main_entity_icon" : "", g = gf(i, r, d), _ = vf(i, r), v = this._computeFullColor(g), y = this._computeFullColor(g), b = this._computeCircleColor(g), ee = d ? this._computeFullColor(g) : this._computeIconColor(g);
	return {
		...e,
		entityId: n,
		stateObj: r,
...
function Af() {
	...
	this._cardName = o ? xt(this._config.status_name, this._config, this.hass) : Q(i, "friendly_name") || Q(r, "friendly_name") || e || t || Y(this.hass, "Person");
	let s = (this._config.label_template ? this._evaluateStateTemplate(this._config.label_template, t) : null) ?? (r ? Mf.call(this, r) : ""), c = a && r?.state !== "home" ? this.formatState(a) : "";
	this._statusText = c ? `${s} | ${c}` : s;
	let l = _f(r, (e) => this._getEntityActiveState(e), this._config.state_template ? this._evaluateStateTemplate(this._config.state_template, t) : null), u = gf(this._config, r, l);
	this._personPicture = Q(i, "entity_picture") || Q(r, "entity_picture") || "", this._personZoneIcon = jf.call(this, r, i), this._personBattery1 = Nf.call(this, this._config.battery_entity_1), this._personBattery2 = Nf.call(this, this._config.battery_entity_2), this._icon = Q(i, "icon") || Q(r, "icon") || "mdi:account", this._navigationPath = vf(this._config, r), this._nameColor = this._computeFullColor(u), this._statusColor = this._computeFullColor(u), this._circleColor = this._computeCircleColor(u), this._iconColor = l ? this._computeFullColor(u) : this._computeIconColor(u), this._iconSvgForceColor = !0;
}
function jf(e, t) {
	if (e?.state === "home") return "mdi:home-variant";
	let n = xf(this.hass), r = t?.entity_id;
	if (r) {
...
function Ff() {
	let e = this._config?.mode || "standard", t = this._statusItems || [], n = e === "icon_only" && t.length > 1, r = Math.max(t.length, 1), i = this._getStatusColumnCount(r), a = this._getStatusRowCount(r), o = Vf(this._statusText), s = this._isImageIcon(this._icon) ? this._resolveIconPath(this._icon) : "", c = s ? this._getInlineSvg(s, this._iconSvgForceColor) : "";
	return O`
    <ha-card
    ...
    >
      ...
      >
        ...
        >
          ${e === "person" ? Rf.call(this) : this._isImageIcon(this._icon) ? O`
                <div
                  class="main-image-icon"
                >
                  ${c ? U(c) : O`<img src=${s} alt="" />`}
                </div>
              ` : this._useNativeMainIcon && this._mainStateObj ? O`
                <ha-state-icon
                  class="main-icon"
    ...
    <div class="status-icon-grid">
      ${Hf(e, t).map((e, n) => O`
        <div class="status-icon-row">
          ${e.map((e, r) => Lf.call(this, e, n * t + r))}
          ${Uf(e.length, t, "status-icon-spacer")}
        </div>
      `)}
    </div>
  `;
...
function Lf(e, t) {
	let n = Vf(e.statusText), r = this._isImageIcon(e.icon) ? this._resolveIconPath(e.icon) : "", i = r ? this._getInlineSvg(r, e.svgForceColor) : "", a = O`
    <div class="circle status-circle">
      ${this._isImageIcon(e.icon) ? O`
            <div class="main-image-icon">
              ${i ? U(i) : O`<img src=${r} alt="" />`}
            </div>
          ` : e.useStateIcon && e.stateObj ? O`
            <ha-state-icon
              class="main-icon"
...
function Rf() {
    ...
    <div class="person-main-icon">
      ...
      ${zf.call(this, "zone", this._personZoneIcon || "mdi:home-minus", this._computeFullColor("blue"))}

      ${this._personBattery1 ? zf.call(this, "battery-1", null, this._personBattery1.color, this._personBattery1.entityId, this._personBattery1.stateObj) : ""}

      ${this._personBattery2 ? zf.call(this, "battery-2", null, this._personBattery2.color, this._personBattery2.entityId, this._personBattery2.stateObj) : ""}
    </div>
  `;
}
function zf(e, t, n, r = null, i = null) {
	let a = Bf(i);
	return O`
    <span
...
function qf({ config: e = {}, itemCount: t = 0, wrapEnabled: n = !!e?.wrap, perRowKey: r = "items_per_row", defaultPerRow: i = 3, scrollThreshold: a = 6 } = {}) {
...
function Jf({ itemCount: e = 0, classPrefix: t, wrapKey: n = "wrap", wrapEnabled: r = !!this._config?.[n], showWrapToggle: i = !0, showSeparateToggle: a = e > 1, separateKey: o = "separate_cards", perRowKey: s = "items_per_row", perRowLabel: c = "Items per row", defaultPerRow: l = 3 } = {}) {
	let u = t || "action";
	return O`
...
function Xf() {
      ...
      <div class="field editor-button-toggle-field">
        <div class="field-header">
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ button_toggle: { options: rp.call(this) } }}
            .value=${e}
    ...
    ${t ? Qf.call(this, {
		...
		"Color"
            ...
            ${this._config?.main_entity ? io.call(this, {
		interactions: [
			{
				key: "tap_action",
				formKey: "tap_action",
...
function Qf({ cardActionDefault: e, mainEntityActionDefault: t }) {
	let n = this._getStatusItems(), r = Math.min(this._selectedStatusIndex || 0, n.length - 1), i = n[r] || {}, { itemsPerRow: a, shouldWrapTabs: o, showTabScrollHint: s } = qf({
		config: this._config,
		itemCount: n.length,
		defaultPerRow: 3
	});
    ...
    <div class="section">
      ...
      ${$f.call(this, "State template", "state_template", r, i)}
      ${$f.call(this, "Label template", "label_template", r, i)}
...
`;
	...
	var e = class extends M {
		...
		connectedCallback() {
			super.connectedCallback(), ss(this), kt(this, "orbit-status-card");
		}
		disconnectedCallback() {
			cs(this), super.disconnectedCallback();
		}
		...
		_handleEntityUpdate(e, t) {
			...
			if (e === "tracker_entity") {
				this._updateConfig(ha("tracker_entity", a));
				return;
			}
			this._handleConfigUpdate(e, t);
		}
		_clearMainEntity() {
			if (this._config?.mode === "person") {
				this._updateConfig(ha("main_entity", i));
				return;
			}
			this._updateConfig(ha("main_entity", n));
		}
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Status Card v{version}", { version: X.status })}
        </div>
      </div>
    `;
		}
	...
	N(), it(), R(), mf(), Ft(), an(), Wn(), Jn(), tn(), Zt(), Qn(), nr(), H(), lf(), Pf(), Wf(), Kf(), cp(), Z();
	var e = class extends M {
		static svgCache = V;
		static get properties() {
			return {
		...
		getLayoutOptions() {
			if (this._config?.mode === "icon_only") {
				let e = Ef(this._config).length, n = t(this._config, e);
				return {
		...
		willUpdate(e) {
			return (e.has("_config") || e.has("hass")) && Rt.call(this, this._getTemplateEntries()), Tf.call(this, e);
		}
		disconnectedCallback() {
			zt.call(this), super.disconnectedCallback();
		}
		...
		_handleTap(e) {
			if (!F(this)) {
				...
				I.call(this, e, this._config.main_entity, this._getCardTapAction(), this._getCardDoubleTapAction());
			}
		}
		_handleDoubleTap(e) {
			if (this._isMainIconEvent(e)) {
			...
			L.call(this, e, this._config.main_entity, this._getCardDoubleTapAction());
		}
		_isMainIconEvent(e) {
		...
		_handleMainEntityTap(e) {
			...
			t && I.call(this, e, t, this._getMainEntityTapAction() || this._getCardTapAction(), this._getMainEntityDoubleTapAction());
		}
		_handleMainEntityDoubleTap(e) {
			L.call(this, e, this._config.main_entity, this._getMainEntityDoubleTapAction());
		}
		...
		_handleCardPointerDown(e) {
			if (F(this) || this._isMainIconEvent(e)) return;
		...
		_handleStatusItemClick(e, t = 0) {
			...
			I.call(this, e, n, r?.action ? r : { action: "more-info" }, i);
		}
		_handleStatusItemDoubleClick(e, t = 0) {
			L.call(this, e, this._getStatusItemEntityId(t), this._isStatusItemMainIconEvent(e) ? this._getStatusItemMainEntityDoubleTapAction(t) : this._getStatusItemCardDoubleTapAction(t));
		}
		...
		_getTemplateEntries() {
			if (this._config?.mode === "icon_only") return Ef(this._config).flatMap((e) => [e.state_template, e.label_template].filter(Boolean).map((t) => ({
				template: t,
		...
		_getRelevantEntities() {
			return this._config?.mode === "icon_only" ? Ef(this._config).map((e) => e.entity || e.main_entity) : [
				this._config?.main_entity,
		...
		_getCardHoldAction() {
			return P(this._config.hold_action) ? this._config.hold_action : null;
		}
		_getCardDoubleTapAction() {
			return P(this._config.double_tap_action) ? this._config.double_tap_action : null;
		}
		_getMainEntityHoldAction() {
			return P(this._config.main_entity_hold_action) ? this._config.main_entity_hold_action : null;
		}
		...
		_getMainEntityDoubleTapAction() {
			return P(this._config.main_entity_double_tap_action) ? this._config.main_entity_double_tap_action : null;
		}
		_getCardTapAction() {
			let e = {
		...
		_getStatusItemCardHoldAction(e = 0) {
			let t = this._statusItems?.[e];
			return P(t?.hold_action) ? t.hold_action : P(this._config.hold_action) ? this._config.hold_action : null;
		}
		_getStatusItemCardDoubleTapAction(e = 0) {
			let t = this._statusItems?.[e];
			return P(t?.double_tap_action) ? t.double_tap_action : P(this._config.double_tap_action) ? this._config.double_tap_action : null;
		}
		...
		_getStatusItemMainEntityDoubleTapAction(e = 0) {
			let t = this._statusItems?.[e];
			return P(t?.main_entity_double_tap_action) ? t.main_entity_double_tap_action : P(this._config.main_entity_double_tap_action) ? this._config.main_entity_double_tap_action : null;
		}
...
function up(e) {
	!e.has("_config") && !e.has("hass") || (this._actions = dp(this._config).map((e) => fp.call(this, e)));
}
function dp(e = {}) {
	return Array.isArray(e.entities) && e.entities.length ? e.entities.map((e) => typeof e == "string" ? { entity: e } : e || {}) : [{
		entity: e.main_entity,
...
function fp(e) {
	let t = e.entity || e.main_entity, n = t && this.hass ? this.hass.states[t] : null, r = e.accent_color || this._config.accent_color || "theme", i = mp(n), a = this._computeCircleColor(r), o = i ? this._computeFullColor(r) : this._computeIconColor(r), s = pp(e, t), c = s === "custom" && (e.main_entity_icon || e.icon) || "", l = s === "custom" && e.main_entity_icon ? "main_entity_icon" : s === "custom" && e.icon ? "icon" : "", u = c || "mdi:play-circle";
	return {
		...e,
		entityId: t,
		stateObj: n,
...
function gp() {
	let e = this._actions || [], t = Math.max(e.length, 1), n = this._getActionColumnCount(t), r = this._getActionRowCount(t), i = vp(e, n);
	return O`
    <ha-card
      ...
      <div class="container action-container">
        ${i.map((e, t) => O`
          <div class="action-row">
            ${e.map((e, r) => _p.call(this, e, t * n + r))}
            ${yp(e.length, n, "action-spacer")}
          </div>
        `)}
      </div>
    </ha-card>
...
function Cp() {
	let e = this._getActionItems(), t = Math.min(this._selectedActionIndex || 0, e.length - 1), n = e[t] || {}, r = this._actionEntityDomainFilter || "all", { itemsPerRow: i, shouldWrapTabs: a, showTabScrollHint: o } = qf({
		config: this._config,
		itemCount: e.length,
...
`;
	...
	var e = class extends M {
		...
		connectedCallback() {
			super.connectedCallback(), ss(this), kt(this, "orbit-action-card");
		}
		disconnectedCallback() {
			cs(this), super.disconnectedCallback();
		}
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Action Card v{version}", { version: X.action })}
        </div>
      </div>
    `;
		}
	...
	N(), it(), or(), R(), mf(), Ft(), Wn(), Qn(), nr(), H(), hp(), bp(), Sp(), kp(), Z();
	var e = class extends M {
		static svgCache = V;
		static get properties() {
			return {
		...
		getLayoutOptions() {
			let e = dp(this._config).length, n = t(this._config, e);
			return {
		...
		shouldUpdate(e) {
			return Yn.call(this, e, dp(this._config).map((e) => e.entity || e.main_entity), { hasTemplates: Xn(this._config) });
		}
		_handleTap(e, t = 0) {
			if (this._longPressTriggered) {
				this._longPressTriggered = !1, this._stopEvent(e);
			...
			I.call(this, e, this._getActionEntityId(t), this._getTapAction(t), this._getDoubleTapAction(t));
		}
		_handleDoubleTap(e, t = 0) {
			L.call(this, e, this._getActionEntityId(t), this._getDoubleTapAction(t));
		}
		_clearDoubleTapTimer() {
			return Ue.call(this);
		}
		...
		_handlePointerDown(e, t = 0) {
			F(this) || (this._stopEvent(e), this._clearHoldTimer(), this._holdTimer = setTimeout(() => {
...
function jp(e = {}) {
	let t = e?.attributes || {};
	return {
		top: Lp(t.padding_top),
		right: Lp(t.padding_right),
		bottom: Lp(t.padding_bottom),
		left: Lp(t.padding_left)
	};
}
function Mp(e = {}) {
	return Object.values(jp(e)).some(Boolean);
}
function Np(e = {}) {
	return e?.attributes?.force_padding === !0;
}
function Pp(e = {}) {
	return Mp(e) && (Np(e) || !Ip(e?.card));
}
function Fp(e = {}) {
	return Np(e) && Mp(e);
}
function Ip(e) {
	return Array.isArray(e) ? e.some((e) => Ip(e)) : !e || typeof e != "object" ? typeof e == "string" ? /\bpadding(?:-(?:top|right|bottom|left))?\b/i.test(e) : !1 : Object.entries(e).some(([e, t]) => e.toLowerCase().includes("padding") || Ip(t));
}
function Lp(e) {
	if (e == null || e === "") return "";
	let t = e.toString().trim();
...
function Vp(e) {
	let t = {}, n = /* @__PURE__ */ new Set();
	return $p.forEach((r) => {
		Object.prototype.hasOwnProperty.call(e, r) && (t[r] = r === "decks" && Array.isArray(e[r]) ? e[r].map(Up) : e[r], n.add(r));
	}), Object.keys(e).forEach((r) => {
		n.has(r) || (t[r] = e[r]);
	}), t;
}
...
function Up(e) {
	...
	let t = {}, n = /* @__PURE__ */ new Set(), r = {
		...e,
		attributes: Wp(e.attributes || {})
	};
	return e.badge?.type ? (r.badge = e.badge, delete r.card) : e.card?.type ? (r.card = e.card, delete r.badge) : (delete r.badge, delete r.card), em.forEach((e) => {
...
var Zp, Qp, $p, em, tm = e((() => {
	N(), ys(), Yf(), os(), Fc(), Op(), lf(), Z(), Nt(), Zp = Symbol.for("orbit-deck-card-preview-selected-index"), Qp = class extends M {
		static properties = {
			hass: { attribute: !1 },
		...
		_updateConfig(e) {
			this._config = Vp(ma(this._config, e)), this._dispatchConfigChanged();
		}
		...
		_getDeckItems(e = this._config) {
			return Array.isArray(e?.decks) ? e.decks.map(Kp) : [];
		}
		_selectDeckItem(e) {
    ...
    `;
      ...
      <div class="section deck-card-tab-section">
        ${this._config?.layout === "wrap" ? Jf.call(this, {
				itemCount: e.length,
				classPrefix: "action",
				wrapEnabled: !0,
				showWrapToggle: !1,
    ...
    `;
		...
		_renderDeckTabs(e, t) {
			let { itemsPerRow: n, shouldWrapTabs: r } = qf({
				config: this._config,
				itemCount: e.length,
    ...
    `;
		...
		_renderDeckInteractions(e, t) {
			let n = t?.attributes || {}, r = Gp(t, "tap_action"), i = Gp(t, "hold_action"), a = Gp(t, "double_tap_action");
			return io.call(this, {
				expanded: !1,
				config: n,
				...
				interactions: [
					...
					},
					{
						...
						defaultAction: a,
						defaultVisible: Yp(a),
						displayDefaultValue: Yp(a)
					}
				],
				context: { entity_id: n.entity || qp(t)?.entity }
			});
		}
    ...
    `;
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Deck Card v{version}", { version: X.deck })}
        </div>
      </div>
    `;
		}
	...
	}, customElements.define("orbit-deck-card-editor", Qp), $p = [
		"type",
		"layout",
		"items_per_row",
		"separate_cards",
	...
	var e = class extends M {
		...
		async _scheduleCardBuild() {
			...
			let r = await this._loadCardHelpers(), i = e.map((e, t) => this._createDeckEntry(e, r, t, S(this._config, e, t)));
		...
		_handleDeckItemPointerDown(e, t) {
			...
			if (P(n)) return this._startLongPress(e, l(t.item), n);
		}
		_handleDeckItemClick(e, t) {
			...
			!P(n) && !P(r) || I.call(this, e, l(t.item), n || { action: "none" }, r);
		}
		_handleDeckItemDoubleClick(e, t) {
			let n = c(t?.item, "double_tap_action");
			P(n) && L.call(this, e, l(t.item), n);
		}
		_renderInteractiveDeckEntry(e) {
			let t = s(e?.item), n = S(this._config, e?.item, e?.index);
			return O`
      <div
    ...
    `;
		...
		_applyDeckPaddingToEntries() {
			let e = this._deckCards.map((e) => S(this._config, e.item, e.index) ? "flat" : "native").join(":"), t = `${x(this._deckCards)}|surface:${e}`;
		...
		_applyDeckCardPadding(e, t = 0) {
			let n = e?.element;
			if (!n) return;
			let r = jp(e.item), i = Pp(e.item);
			(n.updateComplete instanceof Promise ? n.updateComplete : Promise.resolve()).then(() => new Promise((e) => requestAnimationFrame(e))).then(() => {
				let a = ae(n), o = a[0] || null, s = te(this.renderRoot, e.index), c = S(this._config, e.item, e.index);
				if (!(!o && !s)) {
					if ((i || c) && !o && t < 10 && window.setTimeout(() => this._applyDeckCardPadding(e, t + 1), 50), C(n, c), a.forEach((e) => C(e, c)), !i && !o?._orbitDeckPaddingApplied && !s?._orbitDeckPaddingApplied) {
						o && ce(o);
						return;
					}
					s && T(s, r, !1), o && T(o, r, i), i && o ? (D(o, r), requestAnimationFrame(() => {
						s && T(s, r, !1), T(o, r, !0);
					})) : o && ce(o);
				}
			}).catch(() => {});
		...
		_renderWrap(e) {
			let t = this._getVisibleDeckEntries(), n = this._deckCards.filter((e) => e.visible === !1), r = this._getColumnCount(t.length || 1), i = b(t, r);
			return O`
      <ha-card
  ...
  `);
	...
	function x(e = []) {
		return e.map((e) => {
			...
			let t = jp(e.item), n = Np(e.item), r = Pp(e.item);
			return [
				e.index,
				e.kind || d(e.item),
				f(e.item)?.type || "",
	...
	function C(e, t) {
		if (t) {
			e._orbitDeckSurfaceStyles ||= Object.fromEntries(Object.keys(ne).map((t) => [t, {
	...
	function ie(e) {
		e._orbitDeckSurfaceObserver || (e._orbitDeckSurfaceObserver = new MutationObserver(() => {
			e._orbitDeckSurfaceStyles && re(e);
	...
	function ae(e) {
		let t = [];
		return oe(e, t, /* @__PURE__ */ new WeakSet()), t;
	}
	function oe(e, t, n) {
		!e || n.has(e) || (n.add(e), e.localName === "ha-card" && !t.includes(e) && t.push(e), [e.shadowRoot, e].filter(Boolean).forEach((e) => {
			...
			for (let e of r) e.localName === "ha-card" && !t.includes(e) && t.push(e), e.shadowRoot && oe(e, t, n);
		}));
	}
	function T(e, t, n) {
		se(e, n ? t : {
	...
	function se(e, t) {
		E(e, "padding-top", t.top), E(e, "padding-right", t.right), E(e, "padding-bottom", t.bottom), E(e, "padding-left", t.left);
	}
	function E(e, t, n) {
	...
	function D(e, t) {
		e._orbitDeckPadding = t, !e._orbitDeckPaddingObserver && (e._orbitDeckPaddingObserver = new MutationObserver(() => {
			e._orbitDeckPadding && se(e, e._orbitDeckPadding);
...
function rm({ tag: e, badgeClass: t, name: n, description: r, version: i, documentationURL: a }) {
...
function dm(e, t = !1) {
	...
	if (n === "light" && t && Array.isArray(r.rgb_color)) return pm(r.rgb_color);
	let i = fm(e.state), a = t ? "active" : "inactive";
	return [
...
function pm(e) {
	let [t, n, r] = mm(e);
	return n < .4 && (n < .1 ? r = 225 : n = .4), `#${hm(t, n, r).map((e) => e.toString(16).padStart(2, "0")).join("")}`;
}
function mm([e, t, n]) {
	let [r, i, a] = [
		e,
...
var gm, _m, vm = e((() => {
	...
	], _m = new Map(gm.map((e) => [e.value, e]));
})), ym = /* @__PURE__ */ t((() => {
	N(), ys(), Fc(), Nt(), H(), lf(), vm(), Zt(), Z();
	var e = "sensor.orbit_status_badge_preview", t = class extends M {
		static svgCache = V;
		static properties = {
			hass: { attribute: !1 },
			_config: { state: !0 },
		...
		connectedCallback() {
			super.connectedCallback(), ss(this), kt(this, "orbit-status-badge"), queueMicrotask(() => this._syncTemplateSubscriptions());
		}
		disconnectedCallback() {
			this._namePickerEnhanceFrame !== void 0 && (cancelAnimationFrame(this._namePickerEnhanceFrame), this._namePickerEnhanceFrame = void 0), zt.call(this), cs(this), super.disconnectedCallback();
		}
		updated(e) {
		...
		_enhanceNamePicker() {
			let e = this.shadowRoot?.querySelector(".status-badge-name-selector"), t = l(e, "ha-entity-name-picker");
			if (!t) {
			...
			typeof n != "function" || typeof r != "function" || typeof i != "function" || typeof a != "function" || (t.__orbitTemplateNameEnhanced = !0, t._validTypes = (e) => new Set([...r.call(t, e), "template"]), t._formatItem = (e) => e?.type === "template" ? this._t("Template") : i.call(t, e), t._getFilteredItems = () => {
				let e = n.call(t), r = s(t.value), i = t._editIndex != null && r[t._editIndex]?.type === "template";
				if (!r.some((e) => e?.type === "template") || i) {
					let t = String(z.call(this, this._config?.name_template, "") ?? "").trim(), n = this._t("Template"), r = t || this._t("Not configured");
					e.push({
						id: "___template___",
						primary: n,
						secondary: r,
				...
				let n = s(t.value), r = { type: "template" };
		...
		_updateConfig(e) {
			this._config = um(ma(this._config, e)), this._dispatchConfigChanged(this._config);
		}
		...
		_getStateContentHass() {
			let t = (/* @__PURE__ */ new Date()).toISOString(), n = this.hass?.areas?.[this._config?.area]?.name, r = this._config?.name_template?.trim() || "", i = {
				...
				attributes: {
					count: 2,
					friendly_name: ($(this._config) === "template" ? String(z.call(this, r, "") ?? "").trim() : "") || n || "Orbit status"
				},
				last_changed: t,
				last_updated: t,
				context: {
		...
		render() {
			let t = this._config?.display_style === "badge", a = this._getDeviceClassOptions(), o = gm.find((e) => e.value === this._config?.domain), s = [
				...this._config?.show_name === !0 ? ["name"] : [],
				...this._config?.show_state === !1 ? [] : ["state"],
				...this._config?.show_icon === !1 ? [] : ["icon"]
			], c = $(this._config), l = this._config?.entity || "", u = c === "entity" && l ? this.hass : this._getStateContentHass(), d = c === "entity" && l ? l : e;
			return O`
      <div class="wrapper">
        <div class="section">
          ...
          >
            ...
            <div class="content-panel-body">
              ${t ? this._renderColor(["Background", "Color"], "card_color", "primary-color") : O`
                    <div class="field">
                      <ha-selector
                        class=${c === "template" ? "status-badge-name-selector" : ""}
                        .hass=${u}
                        ...
                        .selector=${{ entity_name: { entity_id: d } }}
              ...
              ${t ? "" : O`
				...
				allow_name: !0
                              ...
                              .value=${this._config?.state_content || (c === "entity" ? "state" : "count")}
                              @value-changed=${(e) => this._handleConfigUpdate("state_content", (() => {
				let t = e.detail.value;
				return !t || t === (c === "entity" ? "state" : "count") ? void 0 : t;
			})())}
                            ></ha-selector>
                          </div>
                        `}
        ...
        <div class="editor-version">
          ${this._t("Orbit Status Badge v{version}", { version: X.statusBadge })}
        </div>
      </div>
    `;
		}
    ...
    >
      ...
      <div class="badge-interactions-content">
        ${ro.call(this, "Tap behavior", "tap_action", t, e === "area_count" ? { extraActions: [n] } : void 0)}
        ${ro.call(this, "Hold behavior", "hold_action", "none")}
        ${ro.call(this, "Double tap behavior", "double_tap_action", "none")}
      </div>
    </ha-expansion-panel>
  `;
	}
  ...
  `;
	...
	function i({ stateSource: e, domainConfig: t, deviceClassOptions: n, badgeMode: r }) {
		let i = this._config?.domain || "", s = r ? this._config?.card_visibility || "always" : e, c = r ? [
			{
            ...
            ${t?.requiresDeviceClass && n.length > 0 ? O`
                  <div class="field">
                    <ha-generic-picker
                      ...
                      use-top-label
                      .getItems=${() => p.call(this, i, n)}
                      .valueRenderer=${(e) => m.call(this, i, e)}
                      .rowRenderer=${(e, t) => h(e, t)}
          ...
          ` : s === "template" ? O`
              ${r ? "" : O`
                    <div class="field">
                      ...
                      ></ha-selector>
                      ${a.call(this, this._config?.state_template)}
                    </div>
                  `}
              <div class="field">
                <ha-selector
                ...
                ></ha-selector>
                ${a.call(this, this._config?.active_template)}
              </div>
              ${r ? O`
                    <div class="field">
                      <ha-selector
                      ...
                      ></ha-selector>
                      ${a.call(this, this._config?.inactive_template)}
                    </div>
                  ` : ""}
              ${r ? "" : O`
                    <div class="field">
                      ...
                      ></ha-selector>
                      ${a.call(this, this._config?.name_template)}
                    </div>
                  `}
            ` : ""}
    </div>
  `;
	...
	function a(e, t = "") {
		let n = Bt.call(this, e, t);
		return n ? O`<ha-alert alert-type="error">${n}</ha-alert>` : "";
	}
	function o() {
		let e = sm(this._config), t = e.some((e) => e.type === "hidden"), n = e.filter((e) => e.type === "label").map((e) => e.label), r = ({ hidden: e = t, labels: r = n } = {}) => {
			this._updateConfig({ hide: cm([...e ? [{ type: "hidden" }] : [], ...r.map((e) => ({
				type: "label",
				label: e
			}))]) });
		};
  ...
  `;
	...
	N(), Pr(), it(), im(), R(), an(), Wn(), Jn(), nr(), vm(), H(), Zt(), Z(), lf(), ym();
	var e = class extends M {
		static svgCache = V;
		static properties = {
			hass: { attribute: !1 },
		...
		disconnectedCallback() {
			zt.call(this), this._stopActiveEntitiesDurationTimer(), this._clearDoubleTapTimer(), this._cancelLongPress(), super.disconnectedCallback();
		}
		updated(e) {
		...
		_getModel() {
			let e = $(this._config), t = this._getEntities(), n = t.filter((e) => rn(e)), r = e === "template" ? z.call(this, this._config?.state_template, "") ?? "unavailable" : "", i = this._config?.active_template?.trim() || "", a = e === "template" && i ? z.call(this, i, "") : null, o = this._config?.inactive_template?.trim() || "", s = e === "template" && o ? z.call(this, o, "") : null, c = !!o && Vt(s), l = e === "template" ? Vt(a ?? r) : n.length > 0, u = this._config?.display_style === "badge" && !this._config?.card_visibility ? !0 : l, d = t[0], f = d?.entity_id.split(".")[0] || this._config?.domain || "", p = am(f), g = this._config?.icon_source || (this._config?.icon ? "custom" : "domain"), _ = this._config?.icon || "", v = u ? this._config?.icon_on || _ : this._config?.icon_off || _, y = g === "custom" && v || p.icon, b = u ? this._config?.accent_on_color ?? this._config?.color : this._config?.accent_off_color, ee = !!(b && ![
				...
				"state-active",
				"state-inactive"
			].includes(b) ? "theme" : b, te = e === "template" && this._config?.name_template?.trim() || "", S = te ? z.call(this, te, "") : null, ne = String(S ?? "").trim(), C = e === "template" && !d ? {
				entity_id: "sensor.orbit_status_badge_template",
				state: r || "unavailable",
				attributes: { friendly_name: ne || "Template" }
			} : n[0] || t[0] || {
				entity_id: `${f || "sensor"}.orbit_status_badge`,
				state: u ? "on" : "off",
				attributes: this._config?.device_class ? { device_class: this._config.device_class } : {}
			}, re = ["entity", "template"].includes(e) ? C : {
			...
			return {
				...
				count: n.length,
				displayValue: e === "template" ? r : e === "entity" ? C.state : n.length,
				label: T,
				icon: y,
				iconKey: se,
				iconSource: g,
				...
				hasIconColorOverride: ee,
				iconColor: x === "theme" ? dm(C, u) : at(x)
			};
		}
		_handleAction(e, t = null) {
		...
		_handlePointerDown(e, t) {
			if (P(this._config?.hold_action)) return Gn.call(this, e, t, this._config?.hold_action);
		}
		_handlePointerEnd(e) {
			return qn.call(this, e);
		}
		_handleTap(e, n) {
			...
			return I.call(this, e, n, this._config?.tap_action || r, this._config?.double_tap_action);
		}
		_handleDoubleTap(e, t) {
			return L.call(this, e, t, this._config?.double_tap_action);
		}
		_renderIcon(e) {
      ...
      `;
			if (In(e.icon)) {
				...
				if (t.toLowerCase().split("?")[0].endsWith(".svg")) {
					...
					return e ? O`<span slot="icon" class="image-icon">${U(e)}</span>` : O`<img
              slot="icon"
              src=${t}
              alt=""
              style=${n}
    ...
    `;
		...
		render() {
			let e = this._getModel(), n = e.activeEntities[0]?.entity_id || e.entities[0]?.entity_id || null, r = P(this._config?.tap_action || t(this._config)) || P(this._config?.hold_action) || P(this._config?.double_tap_action), i = this._config?.display_style === "badge", a = this._config?.card_visibility || "always", o = a === "always" || a === "state" && e.isOn || a === "template" && (e.isOn || e.inactiveTemplateActive), s = !i && this._config?.show_state !== !1, c = !i && this._config?.show_name === !0, l = i || this._config?.show_icon !== !1, u = this._config?.card_color ? at(this._config.card_color) : "var(--primary-color)", d = `--badge-color:${e.iconColor};`, f = [
      ...
      ${s ? e.stateSource === "template" ? O`<span class="template-state">${e.displayValue}</span>` : O`
              <state-display
                .hass=${this.hass}
