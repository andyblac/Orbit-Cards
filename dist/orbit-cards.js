...
function nn(e = {}) {
	let t = { ...e || {} }, n = !1;
	return t.type === "custom:orbit-room-card" && (t.type = "custom:orbit-area-card", n = !0), Object.prototype.hasOwnProperty.call(t, "room_name") && (t.area_name === void 0 && t.room_name !== void 0 && t.room_name !== "" && (t.area_name = t.room_name), delete t.room_name, n = !0), n = an(t) || n, {
		config: n ? t : e,
		migrated: n
	};
}
...
var lf, uf, Z = e((() => {
    ...
    `;
		...
		_updateDocumentationContext() {
			Nt(this, this._config?.type || "orbit-area-card", this._activeSection || "card");
		}
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Area Card v{version}", { version: r.area })}
        </div>
      </div>
    `;
		}
...
`;
	...
	var e = class extends j {
		...
		connectedCallback() {
			super.connectedCallback(), ls(this), Nt(this, "orbit-status-card");
		}
		disconnectedCallback() {
			us(this), super.disconnectedCallback();
		}
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Status Card v{version}", { version: r.status })}
        </div>
      </div>
    `;
		}
...
`;
	...
	var e = class extends j {
		...
		connectedCallback() {
			super.connectedCallback(), ls(this), Nt(this, "orbit-action-card");
		}
		disconnectedCallback() {
			us(this), super.disconnectedCallback();
		}
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Action Card v{version}", { version: r.action })}
        </div>
      </div>
    `;
		}
...
var Qp, $p, em, tm, nm = e((() => {
	M(), xs(), Xf(), cs(), Lc(), kp(), Z(), i(), Lt(), Qp = Symbol.for("orbit-deck-card-preview-selected-index"), $p = class extends j {
		static properties = {
			hass: { attribute: !1 },
    ...
    `;
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Deck Card v{version}", { version: r.deck })}
        </div>
      </div>
    `;
		}
	...
	}, customElements.define("orbit-deck-card-editor", $p), em = [
		"type",
		"layout",
		"items_per_row",
		"separate_cards",
...
var Nm, Pm, Fm, Im = e((() => {
	...
	var e = "sensor.orbit_status_badge_preview", t = class extends j {
		...
		connectedCallback() {
			super.connectedCallback(), ls(this), Nt(this, "orbit-status-badge"), queueMicrotask(() => this._syncTemplateSubscriptions());
		}
		disconnectedCallback() {
      ...
      <div class="wrapper">
        ...
        <div class="editor-version">
          ${this._t("Orbit Status Badge v{version}", { version: r.statusBadge })}
        </div>
      </div>
    `;
		}
	...
	customElements.define("orbit-status-badge-editor", t);
	function n(e) {
