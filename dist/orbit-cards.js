...
function Ht(e = {}) {
	let t = { ...e || {} }, n = !1;
	return t.type === "custom:orbit-room-card" && (t.type = "custom:orbit-area-card", n = !0), Object.prototype.hasOwnProperty.call(t, "room_name") && (t.area_name === void 0 && t.room_name !== void 0 && t.room_name !== "" && (t.area_name = t.room_name), delete t.room_name, n = !0), n = Wt(t) || n, {
		config: n ? t : e,
		migrated: n
	};
}
...
var hs = class extends k {
	...
	_updateDocumentationContext() {
		wt(this, this._config?.type || "orbit-area-card", this._activeSection || "card");
	}
...
customElements.define("orbit-area-card-editor", hs), customElements.define("orbit-room-card-editor", _s);
var vs = [
...
`, vc = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), Xa(this), wt(this, "orbit-status-card");
	}
	disconnectedCallback() {
		Za(this), super.disconnectedCallback();
	}
...
customElements.define("orbit-status-card-editor", vc);
function yc(e) {
...
`, Jc = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), Xa(this), wt(this, "orbit-action-card");
	}
	disconnectedCallback() {
		Za(this), super.disconnectedCallback();
	}
...
customElements.define("orbit-action-card-editor", Jc);
function Yc(e) {
...
`, hl = Symbol.for("orbit-deck-card-preview-selected-index"), gl = class extends k {
	static properties = {
		hass: { attribute: !1 },
...
customElements.define("orbit-deck-card-editor", gl);
var _l = [
	"type",
	"layout",
	"items_per_row",
...
var Vu = "sensor.orbit_status_badge_preview", Hu = class extends k {
	...
	connectedCallback() {
		super.connectedCallback(), Xa(this), wt(this, "orbit-status-badge"), queueMicrotask(() => this._syncTemplateSubscriptions());
	}
	disconnectedCallback() {
...
customElements.define("orbit-status-badge-editor", Hu);
function Uu(e) {
